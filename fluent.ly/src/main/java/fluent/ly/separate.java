...
public enum separate {
  ...
  /**
   * Factory method for generating a {@link SeparationSubject}, to be used further
   * for actual separation.
   *
  ...
  /**
   * Separate elements of a given array of <code><b>boolean</b></code>s by a given
   * <code><b>char</b></code>
   *
   ...
   *         of the elements in <code>ls</code> separated by <code>between</code>
   */
   ...
   * @param ¢       a non-<code><b>null</b></code> {@link Map} objects whose
  ...
  public static class SeparationSubject {
     ...
     *         representations of the elements of saved objects <code>between</code>
     */
