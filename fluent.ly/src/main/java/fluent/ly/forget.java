...
@SuppressWarnings("unused") public interface forget {
   ...
   */
  static void em(final double __, final double... ____) {
    /**/ }

  static void em(final double __, final Object... ____) {
    /**/ }
   ...
   * @param ____ more unused parameters
   */
  static void em(final int __, final int... ____) {
    /**/ }
   ...
   * @param ____ more unused parameters
   */
  static void em(final long __, final long... ____) {
    /**/ }
   ...
   */
  static void em(final long __, final Object... ____) {
    /**/ }

  static void em(final Object _1, final Object... _2) {
    /**/ }
