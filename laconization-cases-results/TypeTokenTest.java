 ...
 * @author Sven Mawson
 * @author Ben Yu */
@AndroidIncompatible // lots of failures, possibly some related to bad equals()
                     // implementations?
public class TypeTokenTest extends TestCase {
  ...
  public void testRawTypeIsCorrect() {
    assertEquals(List.class, (new TypeToken<List<String>>() {
    }).getRawType());
  }

  public void testTypeIsCorrect() {
    assertEquals(StringList.class.getGenericInterfaces()[0], (new TypeToken<List<String>>() {
    }).getType());
  }
  ...
  public void testResolveType() throws Exception {
    assertEquals(String.class, new TypeToken<List<String>>() {
    }.resolveType(List.class.getMethod("get", int.class).getGenericReturnType()).getType());
  }
  ...
  public <E extends Comparable<Iterable<String>> & Iterable<Integer>> void testResolveType_fromTypeVariable_onlyDirectBoundsAreUsed() {
    assertEquals(Integer.class, TypeToken.of(new TypeCapture<E>() {
  ...
  public void testGetTypes_withInterfacesAndSuperclasses() {
    ...
    }, TypeToken.of(Class2.class), TypeToken.of(Interface12.class), TypeToken.of(Interface1.class), TypeToken.of(Interface2.class),
        TypeToken.of(Class1.class), TypeToken.of(Object.class));
  ...
  public void testGetTypes_rawTypes_withInterfacesAndSuperclasses() {
    ...
    makeUnmodifiable(types.rawTypes()).containsExactly(Class3.class, Interface3.class, Iterable.class, Class2.class, Interface12.class,
        Interface1.class, Interface2.class, Class1.class, Object.class);
    makeUnmodifiable(types.interfaces().rawTypes()).containsExactly(Interface3.class, Interface12.class, Interface1.class, Interface2.class,
        Iterable.class);
  ...
  public <A extends Interface1 & Interface2 & Interface3<String>> void testGetTypes_manyBounds() {
    makeUnmodifiable(TypeToken.of(new TypeCapture<A>() {
    }.capture()).getTypes().rawTypes()).containsExactly(Interface1.class, Interface2.class, Interface3.class, Iterable.class);
  }

  private static void assertSubtypeFirst(TypeToken<?>.TypeSet ¢) {
    assertSubtypeTokenBeforeSupertypeToken(¢);
    assertSubtypeTokenBeforeSupertypeToken(¢.interfaces());
    assertSubtypeTokenBeforeSupertypeToken(¢.classes());
    assertSubtypeBeforeSupertype(¢.rawTypes());
    assertSubtypeBeforeSupertype(¢.interfaces().rawTypes());
    assertSubtypeBeforeSupertype(¢.classes().rawTypes());
  }

  private static void assertSubtypeTokenBeforeSupertypeToken(Iterable<? extends TypeToken<?>> __) {
    int i = 0;
    for (TypeToken<?> left : ts) {
      int j = 0;
      for (TypeToken<?> right : ts) {
        if (left.isSupertypeOf(right))
          assert (left + " should be after " + right, i >= j);
        ++j;
      }
      ++i;
    }
  ...
  public <T> void testGetGenericSuperclass_typeVariable_unbounded() {
    assertEquals(TypeToken.of(Object.class), TypeToken.of(new TypeCapture<T>() {
  ...
  public <T extends ArrayList<String> & CharSequence, T1 extends T> void testGetGenericSuperclass_typeVariable_boundIsTypeVariableAndClass() {
    assertEquals(TypeToken.of(new TypeCapture<T>() {
    }.capture()), TypeToken.of(new TypeCapture<T1>() {
    }.capture()).getGenericSuperclass());
    assertEquals(TypeToken.of(Object.class), new TypeToken<T[]>() {
    }.getGenericSuperclass());
  }
  ...
  public <T extends NoInterface & Iterable<String>> void testGetGenericInterfaces_typeVariable_boundsAreClassWithInterface() {
    ...
    }.capture()).getGenericInterfaces()).containsExactly(new TypeToken<Iterable<String>>() {
    });
    assertHasArrayInterfaces(new TypeToken<T[]>() {
    });
  }
  ...
  public <T extends CharSequence & Iterable<String>> void testGetGenericInterfaces_typeVariable_boundsAreInterfaces() {
    makeUnmodifiable(TypeToken.of(new TypeCapture<T>() {
    }.capture()).getGenericInterfaces()).containsExactly(TypeToken.of(CharSequence.class), new TypeToken<Iterable<String>>() {
    });
    assertHasArrayInterfaces(new TypeToken<T[]>() {
    });
  }
  ...
  public <T extends CharSequence & Iterable<T>> void testGetGenericInterfaces_typeVariable_boundsAreFBoundedInterfaces() {
    makeUnmodifiable(TypeToken.of(new TypeCapture<T>() {
    }.capture()).getGenericInterfaces()).containsExactly(TypeToken.of(CharSequence.class), new TypeToken<Iterable<T>>() {
    });
    assertHasArrayInterfaces(new TypeToken<T[]>() {
    });
  }
  ...
  public <T extends Base & Iterable<T>> void testGetGenericInterfaces_typeVariable_boundsAreClassWithFBoundedInterface() {
    makeUnmodifiable(TypeToken.of(new TypeCapture<T>() {
    }.capture()).getGenericInterfaces()).containsExactly(new TypeToken<Iterable<T>>() {
    });
    assertHasArrayInterfaces(new TypeToken<T[]>() {
    });
  }
  ...
  public <T extends Iterable<T>, T1 extends T, T2 extends T1> void testGetGenericInterfaces_typeVariable_boundIsTypeVariableAndInterface() {
    ...
    }.capture()).getGenericInterfaces()).containsExactly(TypeToken.of(new TypeCapture<T1>() {
    }.capture()));
    assertHasArrayInterfaces(new TypeToken<T2[]>() {
    });
  }
  ...
  public void testAssignableClassToClass() {
    ...
    assert (tokL.isSupertypeOf(List.class));
    assert (tokL.isSupertypeOf(ArrayList.class));
    assert !(tokL.isSupertypeOf(List[].class));
    TypeToken<Number> tokN = new TypeToken<Number>() {
    };
    assert (tokN.isSupertypeOf(Number.class));
    assert (tokN.isSupertypeOf(Integer.class));
  }

  public <T> void testAssignableParameterizedTypeToObject() {
    assert (TypeToken.of(Object.class).isSupertypeOf(TypeToken.of(new TypeCapture<T>() {
    }.capture())));
    assert !(TypeToken.of(int.class).isSupertypeOf(TypeToken.of(new TypeCapture<T>() {
    }.capture())));
  }

  public <T, T1 extends T> void testAssignableGenericArrayToGenericArray() {
    assert (new TypeToken<T[]>() {
  ...
  public <T, T1 extends T> void testAssignableGenericArrayToClass() {
    assert (TypeToken.of(Object[].class.getSuperclass()).isSupertypeOf(new TypeToken<T[]>() {
    }));
    for (Class<?> interfaceType : Object[].class.getInterfaces())
      assert (TypeToken.of(interfaceType).isSupertypeOf(new TypeToken<T[]>() {
      }));
    assert (TypeToken.of(Object.class).isSupertypeOf(new TypeToken<T[]>() {
    }));
    assert !(TypeToken.of(String.class).isSupertypeOf(new TypeToken<T[]>() {
    }));
  }

  public void testAssignableWildcardBoundedByArrayToArrayClass() {
    Type wildcardType = Types.subtypeOf(Object[].class);
    assert (TypeToken.of(Object[].class).isSupertypeOf(wildcardType));
    assert (TypeToken.of(Object.class).isSupertypeOf(wildcardType));
    assert !(TypeToken.of(wildcardType).isSupertypeOf(wildcardType));
    assert !(TypeToken.of(int[].class).isSupertypeOf(wildcardType));
  }
  ...
  public void testAssignableWildcardTypeParameterToClassTypeParameter() {
    ...
    assert !(new TypeToken<Iterable<Object[]>>() {
    }.isSupertypeOf(wildcardType));
    assert !(new TypeToken<Iterable<Object>>() {
    }.isSupertypeOf(wildcardType));
    assert (wildcardType.isSupertypeOf(wildcardType));
    assert !(new TypeToken<Iterable<int[]>>() {
    }.isSupertypeOf(wildcardType));
  }
  ...
  public void testAssignableArrayClassToBoundedWildcard() {
    ...
    assert !(subtypeOfArray.isSupertypeOf(Object[].class));
    assert !(subtypeOfArray.isSupertypeOf(Object[][].class));
    assert !(subtypeOfArray.isSupertypeOf(String[].class));
    assert (supertypeOfArray.isSupertypeOf(Object[].class));
    assert !(supertypeOfArray.isSupertypeOf(Object.class));
    assert (supertypeOfArray.isSupertypeOf(Object[][].class));
    assert (supertypeOfArray.isSupertypeOf(String[].class));
  }
  ...
  public void testAssignableClassTypeParameterToWildcardTypeParameter() {
    ...
    assert (subtypeOfArray.isSupertypeOf(new TypeToken<Iterable<Object[]>>() {
    }));
    assert (subtypeOfArray.isSupertypeOf(new TypeToken<Iterable<Object[][]>>() {
    }));
    assert (subtypeOfArray.isSupertypeOf(new TypeToken<Iterable<String[]>>() {
    }));
    assert (supertypeOfArray.isSupertypeOf(new TypeToken<Iterable<Object[]>>() {
    }));
    assert (supertypeOfArray.isSupertypeOf(new TypeToken<Iterable<Object>>() {
    }));
    assert !(supertypeOfArray.isSupertypeOf(new TypeToken<Iterable<Object[][]>>() {
    }));
    assert !(supertypeOfArray.isSupertypeOf(new TypeToken<Iterable<String[]>>() {
    }));
  }
  ...
  public void testAssignableNonParameterizedClassToWildcard() {
    ...
    assert !(supertypeOfString.isSupertypeOf(supertypeOfString));
    assert !(supertypeOfString.isSupertypeOf(Object.class));
    assert !(supertypeOfString.isSupertypeOf(CharSequence.class));
    assert (supertypeOfString.isSupertypeOf(String.class));
    assert (supertypeOfString.isSupertypeOf(Types.subtypeOf(String.class)));
  }
  ...
  public void testAssignableWildcardToWildcard() {
    TypeToken<?> subtypeOfArray = TypeToken.of(Types.subtypeOf(Object[].class));
    TypeToken<?> supertypeOfArray = TypeToken.of(Types.supertypeOf(Object[].class));
    assert (supertypeOfArray.isSupertypeOf(subtypeOfArray));
    assert !(supertypeOfArray.isSupertypeOf(supertypeOfArray));
    assert !(subtypeOfArray.isSupertypeOf(subtypeOfArray));
    assert !(subtypeOfArray.isSupertypeOf(supertypeOfArray));
  }
  ...
  public void testAssignableParameterizedTypeToClass() {
    ...
    assert (tokL.isSupertypeOf(StringList.class));
    assert (tokL.isSupertypeOf(StringList.class.getGenericInterfaces()[0]));
    @SuppressWarnings("rawtypes") // Trying to test raw class
    TypeToken<Second> tokS = new TypeToken<Second>() {
    };
    assert (tokS.isSupertypeOf(Second.class));
    assert (tokS.isSupertypeOf(Third.class.getGenericSuperclass()));
  }
  ...
  public void testAssignableArrayToClass() {
    ...
    assert (tokS.isSupertypeOf(Second[].class));
    assert (tokS.isSupertypeOf(Third[].class));
  }
  ...
  public void testAssignableTokenToClass() {
    ...
    assert (tokL.isSupertypeOf(new TypeToken<List>() {
    }));
    assert (tokL.isSupertypeOf(new TypeToken<List<String>>() {
    }));
    assert (tokL.isSupertypeOf(new TypeToken<List<?>>() {
    }));
    TypeToken<Second> tokS = new TypeToken<Second>() {
    };
    assert (tokS.isSupertypeOf(new TypeToken<Second>() {
    }));
    assert (tokS.isSupertypeOf(new TypeToken<Third>() {
    }));
    assert (tokS.isSupertypeOf(new TypeToken<Third<String, Integer>>() {
    }));
    TypeToken<List[]> tokA = new TypeToken<List[]>() {
    };
    assert (tokA.isSupertypeOf(new TypeToken<List[]>() {
    }));
    assert (tokA.isSupertypeOf(new TypeToken<List<String>[]>() {
    }));
    assert (tokA.isSupertypeOf(new TypeToken<List<?>[]>() {
    }));
  }
  ...
  public void testAssignableClassToType() {
    ...
    assert (tokenL.isSupertypeOf(StringList.class));
    assert !(tokenL.isSupertypeOf(List.class));
    TypeToken<First<String>> tokenF = new TypeToken<First<String>>() {
    };
    assert (tokenF.isSupertypeOf(ConcreteIS.class));
    assert !(tokenF.isSupertypeOf(ConcreteSI.class));
  }
  ...
  public void testAssignableParameterizedTypeToType() {
    ...
    assert (tokenL.isSupertypeOf(StringList.class.getGenericInterfaces()[0]));
    assert !(tokenL.isSupertypeOf(IntegerList.class.getGenericInterfaces()[0]));
    TypeToken<First<String>> tokenF = new TypeToken<First<String>>() {
    };
    assert (tokenF.isSupertypeOf(ConcreteIS.class.getGenericSuperclass()));
    assert !(tokenF.isSupertypeOf(ConcreteSI.class.getGenericSuperclass()));
  }
  ...
  public void testGenericArrayTypeToArrayType() {
    ...
    assert (tokL.isSupertypeOf(tokL.getType()));
    assert (tokL.isSupertypeOf(token.getType()));
  }

  public void testAssignableTokenToType() {
    TypeToken<List<String>> tokenL = new TypeToken<List<String>>() {
    };
    assert (tokenL.isSupertypeOf(new TypeToken<List<String>>() {
    }));
    assert (tokenL.isSupertypeOf(new TypeToken<ArrayList<String>>() {
    }));
    assert (tokenL.isSupertypeOf(new TypeToken<StringList>() {
    }));
    TypeToken<First<String>> tokenF = new TypeToken<First<String>>() {
    };
    assert (tokenF.isSupertypeOf(new TypeToken<Second<String>>() {
    }));
    assert (tokenF.isSupertypeOf(new TypeToken<Third<String, Integer>>() {
    }));
    assert !(tokenF.isSupertypeOf(new TypeToken<Third<Integer, String>>() {
    }));
    assert (tokenF.isSupertypeOf(new TypeToken<Fourth<Integer, String>>() {
    }));
    assert !(tokenF.isSupertypeOf(new TypeToken<Fourth<String, Integer>>() {
    }));
    assert (tokenF.isSupertypeOf(new TypeToken<ConcreteIS>() {
    }));
    assert !(tokenF.isSupertypeOf(new TypeToken<ConcreteSI>() {
    }));
  }
  ...
  public void testAssignableWithWildcards() {
    ...
    for (TypeToken<?> ¢ : allTokens)
      assert ((¢ + ""), unboundedToken.isSupertypeOf(¢));
    assert !(upperBoundToken.isSupertypeOf(unboundedToken));
    assert (upperBoundToken.isSupertypeOf(upperBoundToken));
    assert !(upperBoundToken.isSupertypeOf(lowerBoundToken));
    assert (upperBoundToken.isSupertypeOf(concreteToken));
    assert (upperBoundToken.isSupertypeOf(subtypeToken));
    assert !(upperBoundToken.isSupertypeOf(supertypeToken));
    assert !(lowerBoundToken.isSupertypeOf(unboundedToken));
    assert !(lowerBoundToken.isSupertypeOf(upperBoundToken));
    assert (lowerBoundToken.isSupertypeOf(lowerBoundToken));
    assert (lowerBoundToken.isSupertypeOf(concreteToken));
    assert !(lowerBoundToken.isSupertypeOf(subtypeToken));
    assert (lowerBoundToken.isSupertypeOf(supertypeToken));
    for (TypeToken<?> ¢ : allTokens)
      assertEquals((¢ + ""), ¢ == concreteToken, concreteToken.isSupertypeOf(¢));
    for (TypeToken<?> ¢ : allTokens)
      assertEquals((¢ + ""), ¢ == subtypeToken, subtypeToken.isSupertypeOf(¢));
    for (TypeToken<?> ¢ : allTokens)
      assertEquals((¢ + ""), ¢ == supertypeToken, supertypeToken.isSupertypeOf(¢));
  }

  public <N1 extends Number, N2 extends Number, N11 extends N1> void testisSupertypeOf_typeVariable() {
    assertAssignable(TypeToken.of(new TypeCapture<N1>() {
    }.capture()), TypeToken.of(new TypeCapture<N1>() {
    }.capture()));
    ...
    assertAssignable(TypeToken.of(new TypeCapture<N11>() {
    }.capture()), TypeToken.of(new TypeCapture<N1>() {
    }.capture()));
    assertNotAssignable(TypeToken.of(new TypeCapture<N2>() {
    }.capture()), TypeToken.of(new TypeCapture<N1>() {
    }.capture()));
  }
  ...
  public void testisSupertypeOf_resolved() {
    assert !(Assignability.of().isAssignable());
    assert (new Assignability<Integer, Integer>() {
    }.isAssignable());
    assert (new Assignability<Integer, Object>() {
    }.isAssignable());
    assert !(new Assignability<Integer, String>() {
    }.isAssignable());
  ...
  public <From extends String & List<? extends String>> void testMultipleTypeBoundsAssignability() {
    assert (new Assignability<From, String>() {
    }.isAssignable());
    assert !(new Assignability<From, Number>() {
    }.isAssignable());
    assert (new Assignability<From, Iterable<? extends CharSequence>>() {
    }.isAssignable());
    assert !(new Assignability<From, Iterable<Object>>() {
    }.isAssignable());
  }

  private static <N1 extends Number, N11 extends N1> void assignabilityTestWithTypeVariables() {
    assert (new Assignability<N11, N1>() {
    }.isAssignable());
    assert (new Assignability<N11, Number>() {
    }.isAssignable());
    assert !(new Assignability<Number, N11>() {
    }.isAssignable());
  }

  public void testIsArray_arrayClasses() {
    assert (TypeToken.of(Object[].class).isArray());
    assert (TypeToken.of(Object[][].class).isArray());
    assert (TypeToken.of(char[].class).isArray());
    assert (TypeToken.of(char[][].class).isArray());
    assert (TypeToken.of(byte[].class).isArray());
    assert (TypeToken.of(short[].class).isArray());
    assert (TypeToken.of(int[].class).isArray());
    assert (TypeToken.of(long[].class).isArray());
    assert (TypeToken.of(float[].class).isArray());
    assert (TypeToken.of(double[].class).isArray());
    assert !(TypeToken.of(Object.class).isArray());
    assert !(TypeToken.of(void.class).isArray());
  }

  public <T> void testIsArray_genericArrayClasses() {
    assert !(TypeToken.of(new TypeCapture<T>() {
    }.capture()).isArray());
    assert (new TypeToken<T[]>() {
    }.isArray());
    assert (new TypeToken<T[][]>() {
  ...
  public void testIsArray_wildcardType() {
    assert (TypeToken.of(Types.subtypeOf(Object[].class)).isArray());
    assert (TypeToken.of(Types.subtypeOf(int[].class)).isArray());
    assert !(TypeToken.of(Types.subtypeOf(Object.class)).isArray());
    assert !(TypeToken.of(Types.supertypeOf(Object[].class)).isArray());
  }
  ...
  public void testImplicitUpperBoundForWildcards() {
    assertAssignable(new TypeToken<NumberList<? extends Number>>() {
    }, new TypeToken<NumberList<?>>() {
    });
    assertAssignable(new TypeToken<NumberList<? super Integer>>() {
    }, new TypeToken<NumberList<?>>() {
    });
  }
  ...
  public void testToGenericType_staticMemberClass() throws Exception {
    assertThat(((ParameterizedType) TypeToken.toGenericType(GenericClass.class).getType()).getOwnerType()).isEqualTo(
        ((ParameterizedType) TypeTokenTest.class.getDeclaredMethod("getStaticAnonymousClass", Object.class).getGenericReturnType()).getOwnerType());
  }

  public static <T> GenericClass<T> getStaticAnonymousClass(final T value) {
    return new GenericClass<T>() {
      @SuppressWarnings("unused") public T innerValue = value;
    };
  }
  ...
  public void testGetSupertype_withTypeVariable() {
    assertEquals(Types.newParameterizedType(Iterable.class, Types.newParameterizedType(List.class, ListIterable.class.getTypeParameters()[0])),
  ...
  public <A, T extends Number & Iterable<A>> void testGetSupertype_typeVariableWithMultipleBounds() {
    assertEquals(Number.class, new TypeToken<T>(getClass()) {
  ...
  public void testGetSupertype_fromWildcard() {
    ...
    TypeToken<? extends List<String>> type = (TypeToken<? extends List<String>>) TypeToken.of(Types.subtypeOf(new TypeToken<List<String>>() {
    }.getType()));
  ...
  public <T extends Iterable<String>> void testGetSupertype_fromTypeVariable() {
    @SuppressWarnings("unchecked") // to construct TypeToken<T> from
                                   // TypeToken.of()
  ...
  public void testGetSupertype_fromRawClass() {
    assertEquals(Types.newParameterizedType(Iterable.class, List.class.getTypeParameters()[0]), new TypeToken<List>() {
  ...
  public void testGetSupertype_fullyGenericType() {
    assertEquals(
        Types.newParameterizedType(Map.class, ListMap.class.getTypeParameters()[0],
  ...
  public void testGetSubtype_fromWildcard() {
    ...
    TypeToken<? super Iterable<String>> type = (TypeToken<? super Iterable<String>>) TypeToken
        .of(Types.supertypeOf(new TypeToken<Iterable<String>>() {
        }.getType()));
    assertEquals(new TypeToken<List<String>>() {
  ...
  public void testGetSubtype_fromWildcard_lowerBoundNotSupertype() {
    @SuppressWarnings("unchecked") // can't do new TypeToken<? extends ...>() {}
    TypeToken<? super Iterable<String>> type = (TypeToken<? super Iterable<String>>) TypeToken
        .of(Types.supertypeOf(new TypeToken<ImmutableList<String>>() {
        }.getType()));
    try {
      type.getSubtype(List.class);
      fail();
  ...
  public void testGetSubtype_fromWildcard_upperBounded() {
    ...
    TypeToken<? extends Iterable<String>> type = (TypeToken<? extends Iterable<String>>) TypeToken
        .of(Types.subtypeOf(new TypeToken<Iterable<String>>() {
        }.getType()));
    try {
  ...
  public void testGetSubtype_innerTypeOfGenericClassTranslatesOwnerTypeVars() {
    ...
    assertEquals(StringForFirstTypeArg.class, ((ParameterizedType) actualSubtype.getOwnerType()).getRawType());
  }
  ...
  public void testGetSubtype_toWildcardWithBounds() {
    ...
    assert (subtype.isSubtypeOf(supertype));
    // TODO(benyu): This should check equality to an expected value, see
    // discussion in cl/98674873
  ...
  public void testGetSubtype_baseClassWithNoTypeArgs() {
    ...
    assert (subtype.isSubtypeOf(supertype));
    assertEquals(SingleGenericExtendsBase.class, ((ParameterizedType) supertype.getSubtype(subtype.getRawType()).getType()).getRawType());
  }
  ...
  public void testGetSubtype_baseClassInGenericClassWithNoTypeArgs() {
    ...
    assert (TypeToken.of(actualSubtype).isSubtypeOf(supertype));
  }
  ...
  public void testGetSubtype_subtypeSameAsDeclaringType() throws Exception {
    ...
    assertThat(TypeToken.of(SubBar.class.getDeclaredField("delegate").getGenericType()).getSubtype(SubBar.class))
        .isEqualTo(new SubBar<Void>().fieldTypeAsSubBar());
  }

  @SuppressWarnings("unchecked") // To construct TypeToken<T> with
                                 // TypeToken.of()
  ...
  public void testWildcardCaptured_methodParameter_upperBound() throws Exception {
    ...
    assert !((parameterType.getType() + ""), parameterType.isSupertypeOf(new TypeToken<List<Integer>>() {
    }));
  }
  ...
  public void testMethod_declaredBySuperclass() throws Exception {
    ...
    assertEquals((list + ""), TypeToken.of(List.class).method(toStringMethod).invoke(list));
  }

  public <T extends Number & List<String>> void testMethod_returnType_resolvedAgainstTypeBound() throws NoSuchMethodException {
    assertEquals(TypeToken.of(String.class), new TypeToken<T>(getClass()) {
    }.method(List.class.getMethod("get", int.class)).returning(String.class).getReturnType());
  }
  ...
  public void testMethod_equals() throws NoSuchMethodException {
    ...
    Method setMethod = List.class.getMethod("set", int.class, Object.class);
    new EqualsTester().addEqualityGroup(Invokable.from(getMethod), Invokable.from(getMethod)).addEqualityGroup(Invokable.from(setMethod))
  ...
  public <T extends Loser<AssertionError>> void testMethod_exceptionTypes() throws NoSuchMethodException {
    assertThat(new TypeToken<T>(getClass()) {
    }.method(Loser.class.getMethod("lose")).getExceptionTypes()).contains(TypeToken.of(AssertionError.class));
  }
  ...
  public void testConstructor_equals() throws NoSuchMethodException {
    ...
    new EqualsTester().addEqualityGroup(Invokable.from(defaultConstructor), Invokable.from(defaultConstructor))
        .addEqualityGroup(Invokable.from(oneArgConstructor)).addEqualityGroup(new TypeToken<ArrayList<Integer>>() {
  ...
  private static class Container<T> {
    @SuppressWarnings("unused") public Container(T data) {
    }
  }
  ...
  private static class CannotConstruct<E extends Throwable> {
    @SuppressWarnings("unused") public CannotConstruct() throws E {
    }
  }
  ...
  public <T extends CannotConstruct<AssertionError>> void testConstructor_exceptionTypes() throws NoSuchMethodException {
    ...
    assertThat(new TypeToken<T>(getClass()) {
    }.constructor(constructor).getExceptionTypes()).contains(TypeToken.of(AssertionError.class));
  }
  ...
  private static void assertHasTypeVariable(Type t) {
    try {
      TypeToken.of(t).rejectTypeVariables();
      fail("Should contain TypeVariable");
    } catch (IllegalArgumentException expected) {
    }
  }

  private static void assertNoTypeVariable(Type ¢) {
    TypeToken.of(¢).rejectTypeVariables();
  }
  ...
  private abstract static class RawTypeConsistencyTester<T extends Enum<T> & CharSequence> {
    ...
    abstract <T2 extends CharSequence & Iterable<T2>> void acceptT2(T2 t);
    ...
    static void verifyConsitentRawType() {
      for (Method method : RawTypeConsistencyTester.class.getDeclaredMethods()) {
        ...
        for (int ¢ = 0; ¢ < method.getParameterTypes().length; ++¢)
          assertEquals(method.getParameterTypes()[¢], TypeToken.of(method.getGenericParameterTypes()[¢]).getRawType());
      }
    }
  }
  ...
  @CanIgnoreReturnValue private static <T> T reserialize(T object) {
    T $ = SerializableTester.reserialize(object);
    new EqualsTester().addEqualityGroup(object, $).testEquals();
    return $;
  }
  ...
  private static <T, X> TypeToken<T> substitute(TypeToken<T> t, Class<X> arg) {
    return t.where(new TypeParameter<X>() {
    }, arg);
  }
  ...
  // For Guava bug
  // http://code.google.com/p/guava-libraries/issues/detail?id=1025
  ...
  private static void assertAssignable(TypeToken<?> from, TypeToken<?> __) {
    assert (from.getType() + " is expected to be assignable to " + t.getType(), t.isSupertypeOf(from));
    assert (t.getType() + " is expected to be a supertype of " + from.getType(), t.isSupertypeOf(from));
    assert (from.getType() + " is expected to be a subtype of " + t.getType(), from.isSubtypeOf(t));
  }

  private static void assertNotAssignable(TypeToken<?> from, TypeToken<?> __) {
    assert !(from.getType() + " shouldn't be assignable to " + t.getType(), t.isSupertypeOf(from));
    assert !(t.getType() + " shouldn't be a supertype of " + from.getType(), t.isSupertypeOf(from));
    assert !(from.getType() + " shouldn't be a subtype of " + t.getType(), from.isSubtypeOf(t));
  }
  ...
  private static void assertIsPrimitive(TypeToken<?> ¢) {
    assert (¢.isPrimitive());
    assertNotWrapper(¢);
    assertEquals(TypeToken.of(Primitives.wrap((Class<?>) ¢.getType())), ¢.wrap());
  }

  private static void assertNotPrimitive(TypeToken<?> ¢) {
    assert !(¢.isPrimitive());
    assertSame(¢, ¢.wrap());
  }

  private static void assertIsWrapper(TypeToken<?> ¢) {
    assertNotPrimitive(¢);
    assertEquals(TypeToken.of(Primitives.unwrap((Class<?>) ¢.getType())), ¢.unwrap());
  }

  private static void assertNotWrapper(TypeToken<?> ¢) {
    assertSame(¢, ¢.unwrap());
  }

  private static void assertNotPrimitiveNorWrapper(TypeToken<?> ¢) {
    assertNotPrimitive(¢);
    assertNotWrapper(¢);
  }
