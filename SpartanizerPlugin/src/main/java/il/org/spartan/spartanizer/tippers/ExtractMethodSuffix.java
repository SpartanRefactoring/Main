...
public class ExtractMethodSuffix extends ListReplaceCurrentNode<MethodDeclaration>//
  ...
  private static boolean sameParameters(@NotNull final MethodDeclaration d, @NotNull final List<VariableDeclaration> ds) {
  ...
  private static void fixParameters(@NotNull final MethodDeclaration d, @NotNull final MethodDeclaration d2, @NotNull final List<VariableDeclaration> ds) {
    d2.parameters().clear();
  ...
  private static void fixJavadoc(@NotNull final MethodDeclaration d, @NotNull final List<VariableDeclaration> ds) {
