...
public class BlockNanoPatternContainer extends NanoPatternContainer<Block> {
  ...
  @NotNull public BlockNanoPatternContainer statementsPattern(@NotNull final String pattern, @NotNull final String replacement, @NotNull final String description) {
