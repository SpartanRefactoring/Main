...
public enum op {
  ...
  static @SuppressWarnings("serial") Map<Assignment.Operator, InfixExpression.Operator> assign2infix = new HashMap<Assignment.Operator, InfixExpression.Operator>() {
    {
  ...
  static boolean notAssociative(final Operator operator) {
    return in(operator, MINUS2, DIVIDE, REMAINDER, LEFT_SHIFT, RIGHT_SHIFT_SIGNED, RIGHT_SHIFT_UNSIGNED);
  }
