...
public interface Proposition extends BooleanSupplier {
  ...
  @NotNull Proposition and(BooleanSupplier s, BooleanSupplier... ss);
  ...
  class And extends C {
    ...
    @Override @NotNull public Proposition and(final BooleanSupplier s, final BooleanSupplier... ss) {
    ...
    @Override @NotNull public Proposition or(final BooleanSupplier s, final BooleanSupplier... ss) {
  ...
  final class Or extends C {
    ...
    @Override @NotNull public Proposition and(final BooleanSupplier s, final BooleanSupplier... cs) {
    ...
    @Override @NotNull public Proposition or(final BooleanSupplier s, final BooleanSupplier... cs) {
      return add(s, cs);
    }
  }
  ...
  class P extends Implementation<BooleanSupplier> implements Recursive.Atomic<Proposition> {
    ...
    @Override @NotNull public final Proposition and(final BooleanSupplier s, final BooleanSupplier... cs) {
