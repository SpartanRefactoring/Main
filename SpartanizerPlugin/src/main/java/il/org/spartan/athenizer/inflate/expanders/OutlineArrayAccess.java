 ...
 * arr[i]=i. works only on ExpressionStatement, varible declaration with assignment 
 * will be treated after outlining by other expanders
 * .
 * Test case is {@link Issue1004}
...
public class OutlineArrayAccess extends CarefulTipper<ArrayAccess> implements TipperCategory.InVain {
  ...
  @Override protected boolean prerequisite(final ArrayAccess a) {
    ...
    if (!iz.expressionStatement(b) || b.getParent() == null || !iz.block(b.getParent()) || !iz.expressionStatement(b) || !iz.incrementOrDecrement(e) || iz.assignment(e))
      return false;
