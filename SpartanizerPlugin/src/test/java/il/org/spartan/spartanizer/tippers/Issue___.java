 ...
 * </ul>
 * The reason is that
 * <code><b>assert</b> is short, clear, but does not provide as much information as                                           {@link azzert}                                          . In the above situations, a priori there is nothing to print. <p>You can augment <code><b>assert</b> with a short                                          {@link Object}                                           (usually a                                           {@link String}                                          ) that can provide some debugging information (see the implementation of                                          {@link #Z$040()}                                           or                                           {@link #Z$060()}                                          .) <li>Instead, use class                                           {@link azzert}                                           for anything else: <ul>  <li> to check whether something is <code><b>null</b></code>,
 * use <code>azzer.notNull(something)</code> which prints the content of this
