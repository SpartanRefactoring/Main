...
public class FlatMapTest {
  ...
  @Test public void b() {
    topDownTrimming(" for (AtmosphereResourceEventListener ¢ : rImpl)  other.addAll(onBroadcast(e));")//
        .using(EnhancedForStatement.class, new ForEach(), new FlatMap())//
  ...
  @Test public void c() {
    topDownTrimming(" for (AtmosphereResourceEventListener ¢ : rImpl)  other.addAll(¢);")//
        .using(EnhancedForStatement.class, new ForEach(), new FlatMap())//
  ...
  @Test public void d() {
    topDownTrimming(" for (AtmosphereResourceEventListener ¢ : very.complicated(expression))  other.addAll(¢);")//
        .using(EnhancedForStatement.class, new ForEach(), new FlatMap())//
  ...
  @Test public void e() {
    topDownTrimming(" for (A a : B) for(C c : a) other.add(c);")//
        .using(EnhancedForStatement.class, new ForEach(), new FlatMap())//
  ...
  @Test public void f() {
    topDownTrimming(" for (A a : B.f.f()) for(C c : a) other.add(c);")//
        .using(EnhancedForStatement.class, new ForEach(), new FlatMap())//
