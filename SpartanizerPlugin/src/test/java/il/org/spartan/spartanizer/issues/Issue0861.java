...
public class Issue0861 {
  @Test public void t1() {
    topDownTrimming("switch(x) {case a:x=2;y=1;z=3;break;case b:y=1;break;case c:y=2;throw new Exception();case d:y=3;continue;case e:y=1+x+y+z;break;")
  ...
  @Test public void t2() {
    topDownTrimming("switch(x) {default:y=4;break;case a:case b:x=7;break;case c:x=2;break;case d:y=9;case e:x=5;break;")
  ...
  @Test public void t3() {
    topDownTrimming("switch (state) {case DONE:return false;case READY:return true;default:}").stays();
  }
}
