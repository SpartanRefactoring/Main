...
public class EnvironmentTestEngineTest {
  ...
  @Test public void EngineTestFlatUnordered00() {
    new EnvFlatHandler(makeAST1.COMPILATION_UNIT.from(new Document("@FlatEnvUse({}) int x;")), s);
  }

  @Test public void EngineTestFlatUnordered000() {
    final ASTNode $ = makeAST1.COMPILATION_UNIT
  ...
  @Test public void EngineTestFlatUnordered02() {
    final ASTNode $ = makeAST1.COMPILATION_UNIT.from(new Document("class A {@FlatEnvUse({ @Id(name = \"str\", clazz = \"String\") }) int x}"));
    s.add(new MapEntry<>("str", new Binding(type.Primitive.Certain.STRING)));
    new EnvFlatHandler($, s);
  }
  ...
  @Test public void EngineTestFlatUnordered04() {
    final ASTNode $ = makeAST1.COMPILATION_UNIT.from(new Document("class A {@FlatEnvUse({ @Id(name = " + "\"a\", clazz = \"String\") }) \n"
  ...
  @Test public void EngineTestFlatUnordered05() {
    final ASTNode $ = makeAST1.COMPILATION_UNIT.from(new Document("class A {@FlatEnvUse({ @Id(name = " + "\"s\", clazz = \"String\") })"
  ...
  @Test public void EngineTestFlatUnordered07() {
    final ASTNode $ = makeAST1.COMPILATION_UNIT.from(new Document(
  ...
  @Test public void EngineTestNested01() {
    final ASTNode $ = makeAST1.COMPILATION_UNIT.from(new Document("class A {@NestedENV({ @Id(name = " + "\"EX.s\", clazz = \"String\"), "
