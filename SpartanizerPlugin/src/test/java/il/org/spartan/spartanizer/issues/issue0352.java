...
public class issue0352 {
  @Test public void a() {
    topDownTrimming("@Override    Iterator<Entry<Cut<C>, Range<C>>> entryIterator() {      if (restriction.isEmpty())"
  ...
  @Test public void b() {
    topDownTrimming("if (a())     return 0;   if (a())     return 1;   else {     int b = c(5) + 7;     return c(b+b+b);}")
