...
@SuppressWarnings({ "static-method", "javadoc" }) public class Issue741 {
  @Test public void publicFields_test0() {
    collect.publicFields(null);
    assert true;
  }
  @SuppressWarnings("cast") @Test public void publicFields_test1() {
    assertTrue(collect.publicFields(null) instanceof List<?>);
  }
  @Test public void publicFields_test2() {
    assertNotNull(collect.publicFields(null));
  }
  @Test public void publicFields_test3() {
    assertEquals(0, collect.publicFields(null).size());
  }
  @Test public void publicFields_test4() {
    assertEquals(0, collect.publicFields(getTypeDeclaration("public class A {}")).size());
  }
  @Test public void publicFields_test5() {
    assertEquals(0, collect.publicFields(getTypeDeclaration("public class A { private int x; protected String s; }")).size());
  }
  @Test public void publicFields_test6() {
    ...
    final List<String> pFields = collect.publicFields(td);
