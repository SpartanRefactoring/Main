...
public class Issue0364 {
  @Test public void emptyInitializer() {
    trimminKof("Object[] os = {};S.out.println(os);").givesEither("S.out.println((new Object[] {}));", "S.out.println(new Object[] {});");
  }

  @Test public void notTerminating() {
    trimminKof("void f() { String[] x = {\"\"}; g(x); h();}")//
        .gives("void f() { g(new String[] {\"\"}); h();}");
  }

  @Test public void notTerminatingRealWorld() {
    trimminKof("@Test public void fz() throws E { String[] cmd = {S.p(\"java.home\") + F.s + \"bin\""
  ...
  @Test public void realLifeExample() {
    trimminKof("if (opterr) { final Object[] msgArgs = { progname, Character.valueOf((char) c) + \"\" };"
