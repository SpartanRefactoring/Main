...
public class Issue885 {
  @Test public void a() {
    trimmingOf(
  "  @A protected B a(final B b, final C c, final D d, final E e," + "      final F f, final G g) {" + "    if (e == null || h.i(c))"
  ...
  "  @A protected B a(final B $, final C c, final D d, final E e," + "      final F f, final G g) {" + "    if (e == null || h.i(c))"
      + "      return null;" + "    final H j = k.l(f);" + "    if (j == null)" + "      return null;" + "    final I m = k.n(o.p(j));"
      + "    if (m == null || !q.r(d, s(m)) || m.t() != J)" + "      return null;" + "    final E u = v.w(x(m));"
