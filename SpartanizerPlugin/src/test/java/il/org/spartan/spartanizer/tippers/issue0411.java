...
public class issue0411 {
  ...
  @NotNull NumberLiteral one = findFirst.instanceOf(NumberLiteral.class).in(input1);
  final Statement seriesA$step1 = into.s(INPUT);
  @NotNull EnhancedForStatement seriesA$step2 = findFirst.instanceOf(EnhancedForStatement.class).in(seriesA$step1);
  final BooleanLiteral seriesA$step3 = findFirst.instanceOf(BooleanLiteral.class).in(seriesA$step1);
  @NotNull EnhancedForStatement seriesB$step2 = findFirst.instanceOf(EnhancedForStatement.class).in(seriesA$step1);
