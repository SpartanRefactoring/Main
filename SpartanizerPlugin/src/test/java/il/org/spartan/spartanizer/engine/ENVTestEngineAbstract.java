...
public abstract class ENVTestEngineAbstract {
  ...
  @Nullable protected static LinkedHashSet<Entry<String, Binding>> userProvidedSet;
   ...
   * @param ¢ */
  static void compare(@NotNull final LinkedHashSet<Entry<String, Binding>> ¢) {
   ...
   *         equally the same. */
  private static void compareInOrder(@NotNull final LinkedHashSet<Entry<String, Binding>> contains,
      @NotNull final LinkedHashSet<Entry<String, Binding>> contained) {
  ...
  private static void compareOutOfOrder(@NotNull final LinkedHashSet<Entry<String, Binding>> contains,
      @NotNull final LinkedHashSet<Entry<String, Binding>> contained) {
    assert contains != null;
    assert contained != null;
  ...
  protected void runTest() {
    n.accept(new ASTVisitor() {
      ...
      void checkAnnotations(@NotNull final List<Annotation> as) {
