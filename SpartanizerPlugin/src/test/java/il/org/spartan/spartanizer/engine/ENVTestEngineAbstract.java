...
public abstract class ENVTestEngineAbstract {
  ...
  private static void compareInOrder(@NotNull final Iterable<Entry<String, Binding>> contains, @NotNull final Iterable<Entry<String, Binding>> contained) {
  ...
  private static void compareOutOfOrder(@NotNull final Collection<Entry<String, Binding>> contains, @NotNull final Collection<Entry<String, Binding>> contained) {
    assert contains != null;
    assert contained != null;
