 ...
 * @since 2017-01-09 */
@Ignore("Yuval Simon") // This is critical
...
public class Issue0860 {
  ...
  @Test public void t2() {
    trimmingOf("switch(x) {case 2:case 1:case 3:case 10:x = 2;break;}").gives("switch(x) {case 1:case 2:case 3:case 10:x = 2;break;}");
  }

  @Test public void t3() {
    trimmingOf("switch(x) {case 'b':case 'c':case 'a':case 'd':x = 2;break;}").gives("switch(x) {case 'b':case 'a':case 'c':case 'd':x = 2;break;}")
