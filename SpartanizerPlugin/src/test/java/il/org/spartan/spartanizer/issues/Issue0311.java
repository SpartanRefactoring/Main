...
public class Issue0311 {
  @Test public void a() {
    topDownTrimming("while(zq<ng.l()&&m.f(zq)){int x=m.zq();int eA=m.z();int lE=eA-x;p(lE);I[] ch=y(x,lE);if((c==null)||c.k(ch))st.$(ch);zq=eA;}")//
  ...
  @Test public void b() {
    topDownTrimming("y=1;while(sg.t(y)!=')'){int d=gT(sg.ss(y));$ +=size(d);y +=consumed(d);}").stays();
  }

  @Test public void ca() {
    topDownTrimming("for(int i=0;i<20;++i){F f=q.f();a3xZ(s.l(c),not(r4(f)));" + //
        "c[i]=f;new F(f,\"a.txt\").g();a(f.e());}")//
            .stays();
  }

  @Test public void cb() {
    topDownTrimming("for(int i=0;i<20;++i){a3xZ(s.l(c),not(r4(f)));" + //
        "c[i]=f;new F(f,\"a.txt\").g();a(f.e());}")//
  ...
  @Test public void challenge_for_i_initialization_expression_3a() {
    topDownTrimming("boolean b;for(;b=true;)$.ap(line).ap(ls);")//
  ...
  @Test public void d() {
    topDownTrimming("static S eE(I ¢){S $=¢.e2();" + //
        "while($ instanceof I)$=((I)$).e2();return $;}")//
            .stays();
  }

  @Test public void e_Modifiers_in_1() {
    topDownTrimming("public S bv(){S a=\"\";M m=R.mp(\"[A-Z]\").m(q);" + //
  ...
  @Test public void e_Modifiers_in_2a() {
    topDownTrimming("c(int i){int p=i;while(p<10)++p;return false;}")//
        .gives("c(int i){for(int p=i;p<10;)++p;return false;}")//
        .stays();
  }

  @Test public void e_Modifiers_in_2b() {
    topDownTrimming("c(int i){int p=i;while(p<10)++i;return false;}")//
        .gives("c(int i){for(int p=i;p<10;)++i;return false;}")//
        .stays();
  }

  @Test public void for_1() {
    topDownTrimming("c(N n){N p=n;for(;p!=null;){if(dns.c(p))return true;++i;}return false;}")
        .gives("c(N n){for(N p=n;p!=null;){if(dns.c(p))return true;++i;}return false;}")//
        .stays();
  }

  @Test public void for_2() {
    topDownTrimming("c(int i){int p=i;for(;p<10;)++p;return false;}")//
        .gives("c(int i){for(int p=i;p<10;)++p;return false;}")//
        .stays();
  }

  @Test public void for_3a() {
    topDownTrimming("c(int i){int p=i,a=0;for(;p<10;){++p;--a;}return false;}").gives("c(int i){for(int p=i,a=0;p<10;){++p;--a;}return false;}")
  ...
  @Test public void for_3b() {
    topDownTrimming("c(int i){int p=i,a=0;for(;p<10;){++p;--a;k+=p+a;}return false;}")
        .gives("c(int i){for(int p=i,a=0;p<10;){++p;--a;k+=p+a;}return false;}")//
        .stays();
  }

  @Test public void for_5() {
    topDownTrimming("c(int i){int p=i;for(int k=2;p<10;){++nE;++p;}return false;}").gives("c(int i){for(int p=i,k=2;p<10;){++nE;++p;}return false;}")
        .gives("c(int i){for(int p=i,k=2;p<10;++p){++nE;}return false;}").gives("c(int i){for(int p=i,k=2;p<10;++p)++nE;return false;}")//
        .stays();
  }

  @Test public void h() {
    topDownTrimming("int i=0;while(i<p7.size()-1)if(p7.g(i).t()!=N.Y ||p7.g(i+1).t()!=N.Y)" + //
  ...
  @Test public void i_initialization_expression_1() {
    topDownTrimming("S line;while((line=reader.readLine())!=null)$.ap(line).ap(ls);").gives("for(S line=reader.readLine();line!=null;)$.ap(line).ap(ls);")//
        .stays();
  }

  @Test public void i_initialization_expression_2a() {
    topDownTrimming("S line;while(null!=(line=reader.readLine()))$.ap(line).ap(ls);").gives("for(S line=reader.readLine();null!=line;)$.ap(line).ap(ls);")
        .gives("for(S line=reader.readLine();line!=null;)$.ap(line).ap(ls);")//
        .stays();
  }

  @Test public void i_initialization_expression_2b() {
    topDownTrimming("int line;while(0<(line=1))++line;")//
  ...
  @Test public void i_initialization_expression_2c() {
    topDownTrimming("int line;while(0<(line=1)){--a;++line;}")//
  ...
  @Test public void i_initialization_expression_2d() {
    topDownTrimming("int line;while(0<(line=1)){a=line;++line;}")//
  ...
  @Test public void i_initialization_expression_3a() {
    topDownTrimming("boolean b;while(b=true)$.ap(line).ap(ls);")//
        .gives("for(boolean b=true;b;)$.ap(line).ap(ls);")//
        .gives("for(boolean ¢=true;¢;)$.ap(line).ap(ls);")//
        .stays();
  }
  ...
  @Test public void i_initialization_expression_3e() {
    topDownTrimming("boolean a,b,c;while((b=true)&&(a=true)&&(c=true))$.ap(line).ap(ls);")
  ...
  @Test public void i_initialization_expression_4() {
    topDownTrimming("boolean a,b,c;while((b=true)&&(a=true)&&(d=true))$.ap(c).ap(ls);")
        .gives("for(boolean a=true,b=true,c;b&&a&&(d=true);)$.ap(c).ap(ls);").gives("for(boolean ¢=true,b=true,c;b&&¢&&(d=true);)$.ap(c).ap(ls);")//
        .stays();
  }

  @Test public void j() {
    topDownTrimming("public S bv(){S a=\"\";M m=R.mp(\"[A-Z]\").m(q);while(m.f())a +=m.u();return a.e2();}")
  ...
  @Test public void k() {
    topDownTrimming("static void eA(boolean b,L<E> xs){for(E ¢=f(b,xs);;){if(¢==null)return;xs.v(¢);}}")//
        .stays();
  }
  ...
  @Test public void t03a() {
    topDownTrimming("S t(S g){B sb=new B(g);int l=sb.l();for(int i=0;i<l;++i)if(sb.t(i)=='.')sb.s(i,'/');return sb+\"\";")
  ...
  @Test public void t03c() {
    topDownTrimming("S t(S s){int $=0,one=1;while($<one){if($==0)$=7;++$;}return $;}")
  ...
  @Test public void t03d() {
    topDownTrimming("S t(S g){int $=0,one=1;while($<one){if($==0)$=7;++$;}return g;}")//
  ...
  @Test public void t04() {
    topDownTrimming("c(N n){N p=n;while(p!=null){if(dns.c(p))continue;p=p.e();}return false;}")
  ...
  @Test public void t05() {
    topDownTrimming("static S eE(I ¢){S $=¢.e2();while($ instanceof I)$=((I)$).e2();return $;}")//
        .stays();
  }

  @Test public void t06a() {
    topDownTrimming("c(N n){N p=n;while(p!=null)f();return false;}")//
        .gives("c(N n){for(N p=n;p!=null;)f();return false;}")//
        .stays();
  }

  @Test public void t06b() {
    topDownTrimming("c(N n){N p=n;while(p!=null){f();g();h();}return false;}")//
        .gives("c(N n){for(N p=n;p!=null;){f();g();h();}return false;}")//
        .stays();
  }

  @Test public void t06c() {
    topDownTrimming("c(int i){int p=i;while(p!=null){++p;--i;h(p);}return false;}").gives("c(int i){for(int p=i;p!=null;){++p;--i;h(p);}return false;}")//
        .stays();
  }

  @Test public void while_1() {
    topDownTrimming("c(N n){N p=n;while(p!=null){if(dns.c(p))return true;++i;}return false;}")
  ...
  @Test public void while_3() {
    topDownTrimming("c(int i){int p=i,a=0;f(++a);while(p<10)++p;return false;}")//
        .stays();
  }

  @Test public void while_4() {
    topDownTrimming("c(N i){N p=i;int a=5;f(++a);while(p<10)p=p.e();return false;}")//
        .stays();
  }

  @Test public void with_aay_a() {
    topDownTrimming("int[] a=new int[]{1,2,3,4,5};for(int i=0;;){a[i]=0;++i;}")//
