...
public class Issue0975 {
  ...
  public static class ToFix { // should pass after fixing {@link Issue0974}
    @Ignore @Test public void notSimpleShouldntAddTest() {
      bloatingOf("for(int i=0;i<5;i++){ a=5;b=3;}")//
          .gives("for(int i=0;i<5;i=i+1){a=5;b=3;}")//
          .stays();
    }
    @Ignore @Test public void simpleBlockTest() {
      bloatingOf("for(int i=0;i<5;i++) a=5;")//
          .gives("for(int i=0;i<5;i++){a=5;}")//
          .gives("for(int i=0;i<5;i=i+1){a=5;}")//
          .stays();
    }
    @Ignore @Test public void simpleShouldntAddTest() {
      bloatingOf("for(int i=0;i<5;i++){ a=5;}")//
          .gives("for(int i=0;i<5;i=i+1){a=5;}")//
          .stays();
    }
