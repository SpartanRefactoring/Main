...
public class Issue1286 { 
  @Test public void basic() {
    bloatingOf(new Gives()).givesWithBinding("int f1() {"
        + "int t1 = x1(x);"
        + "y = x2(t1);"
        + "return y;"
        + "}", "f1");
  ...
  @Test public void basic2() {
    bloatingOf(new Gives()).givesWithBinding("void f2() {"
  ...
  @Test public void bugAmbiguity() {
    bloatingOf(new Gives()).givesWithBinding("void f3() {"
        + "InfixExpression t1 = az.infixExpression(a);"
        + "b = copy.of(t1);"
  ...
  public static class Gives extends MetaFixture {
    ...
    private int x1(int k) {
      return x + k;
    }
    
    
    private Integer x2(Integer k) {
      return x + k;
    }
  }
