...
public enum BitSet {
   ...
   * positions given by a bit representation of such a set. If <code>s</code> is a
   * <code><b>short</b></code> value whose bit representing encodes a set of
   * positions, then <code>positions[s]</code> is an array of the integers, in an
   * increasing order, that occur in this set. */
   ...
   * @return <code><b>true</b></code> <i>iff</i> <code>n</code> is a member of the
   *         set <code>mask</code> */
