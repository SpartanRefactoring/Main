...
@Utility public enum Parenthesize {
   ...
   * @param ts      the actual items in the list, method <code>toString()</code>
   *                is used to compute obtain each item string representation.
   ...
   *         <p>
   *         are the non-<code><b>null</b></code> elements of the <code>ts</code>
   *         parameter. If however there are no on- <code><b>null</b></code>
   *         elements in <code>ts</code> or <code>ts</code> is <code>null</code>,
