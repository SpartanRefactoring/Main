...
@Utility public enum Separate {
   ...
   * @param f       a function object, providing a function that translates an
   *                object of type <code>T</code> into a {@link String}
   * @param between what should be used for separating these elements
   ...
   * <code><b>char</b></code>, where the textual representation of each object is
   * obtained by a user supplied function.
   *
   ...
   * @param m       a non-<code><b>null</b></code> {@link Map} objects whose
   *                entries are to be separated.
   * @param between a non-<code><b>null</b></code> specifying what should be used
   *                for separating these entries.
   ...
   * commas where the textual representation of each object is obtained by a user
   * supplied function.
   *
   * @param ts  an {@link Iterable} collection of elements to be separated
   * @param <T> type of elements in the {@link Iterable} collection parameter
   ...
   * implementation to function {@link #__(Object)}, and then pass an instance of
   * this subclass class.
   *
   * @author Yossi Gil, the Technion.
   * @since 07/08/2008
