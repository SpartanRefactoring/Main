...
@UnderConstruction("yogi -- 25/07/2020")
...
public class RawTokenizer {
   ...
   * @param pos the position of the character to fetch. A value from 0 toyylength()-1.
   ...
   * @param number the number of characters to be read again. This number must notbe greater than yylength()! 
   */
