...
public enum Filename {
   ...
   * @return the longest prefix of name that is followed by a {@link #DOT}, or the
   *         empty {@link String} if no such prefix exists.
   * @see #tailPart(String) */
   ...
   *
   * @param name a class name to process
   * @return <code><b>true</b></code> <em>iff</em>the class is a local one, i.e.,
