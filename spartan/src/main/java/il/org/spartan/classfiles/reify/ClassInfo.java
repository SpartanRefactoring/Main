...
public final class ClassInfo extends ConstantPoolEntity {
  ...
  public static class Builder extends RobustReader {
     ...
     *
     * @param c a non-<code><b>null</b></code> representing a valid {@link Class}
     *          object */
    ...
    /** Instantiate this class from a given file name.
     *
     * @param f a non-<code><b>null</b></code> representing a valid <tt>.class</tt>
     *          file name @ * in case the file could not be opened or processed */
     ...
     *
     * @param s a non-<code><b>null</b></code> providing a stream of a class file
     *          starting at the first byte. @ * in case of reading errors or invalid
     *          class file. */
  ...
  public enum Kind {
    ...
    public static Kind kind(final ClassInfo ¢) {
      return ¢.isInterface() ? Kind.INTERFACE
          : ¢.isClass() ? Kind.CLASS : ¢.isEnum() ? Kind.ENUM : ¢.isAnnotation() ? Kind.ANNOTATION : null;
    }
  }

  public enum LinkComponents {
    SuperClass, SuperInterface, FieldDeclaration, MethodDeclaration, Instantiation, FieldAccess, StaticFieldAccess,
    MethodInvocation, StaticMethodInvocation
  }
}
