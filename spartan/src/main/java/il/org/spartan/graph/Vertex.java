...
public class Vertex<@Nullable E> {
   ...
   * instantiating vertices rather than obtaining these from the containing graph.
   *
  ...
  /** Which vertices lie on the other end of outgoing edges? Package visibility is
   * deliberate; access to to neighbors must be through the enclosing graph, so as
   * to make it possible to invert edge directionality
   *
  ...
  /** Which vertices lie on the other end of incoming edges? Package visibility is
   * deliberate; access to to neighbors must be through the enclosing graph, so as
   * to make it possible to invert edge directionality
   *
