...
public abstract class AbstractGraph<E> {
   ...
   *
   * @param ¢ some Vertex<E>
   * @return if v has no incoming edges then <code><b>null</b></code>, otherwise,
   *         all vertices from which there an edge leading to v. */
   ...
   *
   * @param ¢ some Vertex<E>
   * @return <code><b>true</b></code> if and only if this Vertex<E> is a source */
   ...
   *
   * @param ¢ some Vertex<E>
   * @return if v has no outgoing edges then <code><b>null</b></code>, otherwise,
   *         all vertices u such that there is an edge emanating from v and
   *         leading to u */
   ...
   * the sinks, where this array is created by a full iteration over all vertices
  ...
  /** Return one of the sources of a given Vertex<E>. A Vertex<E> <em>r</em> is a
   * source of a Vertex<E> <i>v</i> if <i>v</i>can be reached from <i>r</i>, and
   * if there is another Vertex<E> <i>r'</i> from which <i>r</i> can be reached,
   * then there is also a path from <i>r</i> to <i>r'</i>.<i>r</i>
   *
