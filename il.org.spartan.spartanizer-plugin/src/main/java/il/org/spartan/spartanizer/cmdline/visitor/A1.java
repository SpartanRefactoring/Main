...
public interface A1 {
  ...
  interface E {
    interface Delegator<S extends E.Set> extends E.Set, A0.Listener.Delegator<S> {
    ...
    interface Idle extends Set, A0.Listener.Idle {
      @Override default void end() { /**/}
    }

    /* Empty protocol */
    interface Set extends E, A0.Listener.Protocol {
      void end();
    }
  }
}
