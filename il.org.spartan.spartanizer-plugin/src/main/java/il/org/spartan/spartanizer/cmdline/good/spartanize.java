 ...
 * corresponding {@code .javas} file, which is the spartanized version of the original.
 * The {@code .javas} will be in the same folder as the {@code .java} file, and would
 * be overwritten each time this program is done.
 * @author Matteo Orru'
 * @since 2017-06-25 */
