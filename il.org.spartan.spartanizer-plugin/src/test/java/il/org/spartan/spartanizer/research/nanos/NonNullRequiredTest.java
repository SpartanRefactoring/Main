...
/** Tests {@link NonNullRequired}
 * @author orimarco {@code marcovitch.ori@gmail.com}
 * @since 2017-01-08 */
@SuppressWarnings("static-method")
public class NonNullRequiredTest {
  @Test public void a() {
    trimmingOf("void m(){if(x == null) return; use(); use();}")//
        .using(new NonNullRequired(), IfStatement.class)//
        .gives("void m(){azzert.NonNull(x);use();use();}")//
  ...
  @Test public void a2() {
    trimmingOf("void m(){if(x == null || y == null) return; use(); use();}")//
        .using(new NonNullRequired(), IfStatement.class)//
        .gives("void m(){azzert.NonNull(x,y);use();use();}")//
  ...
  @Test public void d() {
    trimmingOf("void m(){if(x == null || null == abc.b) return null; use(); use();}")//
        ...
        .using(new NonNullRequired(), IfStatement.class)//
        .gives("void m(){azzert.NonNull(x,abc.b);use();use();}")//
