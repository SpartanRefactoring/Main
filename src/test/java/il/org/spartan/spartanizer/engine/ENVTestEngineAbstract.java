...
public abstract class ENVTestEngineAbstract {
   ...
   *         equally the same. */
  private static void compareInOrder(@NotNull final LinkedHashSet<Entry<String, Binding>> contains, @NotNull final LinkedHashSet<Entry<String, Binding>> contained) {
  ...
  private static void compareOutOfOrder(@NotNull final LinkedHashSet<Entry<String, Binding>> contains, @NotNull final LinkedHashSet<Entry<String, Binding>> contained) {
    assert contains != null;
    assert contained != null;
