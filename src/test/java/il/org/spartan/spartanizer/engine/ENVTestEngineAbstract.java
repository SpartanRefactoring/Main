...
public abstract class ENVTestEngineAbstract {
  ...
  protected static LinkedHashSet<Entry<String, Symbol>> testSet;
  // Optionally provided by the user, in order to test the test engine.
  protected static LinkedHashSet<Entry<String, Symbol>> userProvidedSet;
  ...
  public static void addTestSet(final List<MemberValuePair> ps) {
    ...
    testSet.add(new MapEntry<>(s1.substring(1, s1.length() - 1), new Symbol(type.baptize(s2.substring(1, s2.length() - 1)))));
  }
   ...
   * @param ¢ */
  static void compare(final LinkedHashSet<Entry<String, Symbol>> ¢) {
  ...
  private static void compareInOrder(final LinkedHashSet<Entry<String, Symbol>> contains, final LinkedHashSet<Entry<String, Symbol>> contained) {
    ...
    for (final Entry<String, Symbol> ¢ : contained) {
  ...
  protected static LinkedHashSet<Entry<String, Symbol>> generateSet() {
  ...
  private static boolean testSetContainsVarName(final String s) {
    for (final Entry<String, Symbol> ¢ : testSet)
      if (¢.getKey().equals(s))
        return true;
    return false;
  }
  ...
  public void runTest() {
    n.accept(new ASTVisitor() {
      ...
      void visitNodesWithPotentialAnnotations(final BodyDeclaration $) {
        ...
        final LinkedHashSet<Entry<String, Symbol>> enviromentSet = buildEnvironmentSet($);
