...
public abstract class ENVTestEngineAbstract {
   ...
   *         equally the same. */
  private static void compareInOrder( final LinkedHashSet<Entry<String, Binding>> contains,
       final LinkedHashSet<Entry<String, Binding>> contained) {
  ...
  private static void compareOutOfOrder( final LinkedHashSet<Entry<String, Binding>> contains,
       final LinkedHashSet<Entry<String, Binding>> contained) {
    assert contains != null;
    assert contained != null;
