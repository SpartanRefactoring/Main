...
public class Issue0763 {
  @Test public void a() {
    azzert.that(analyze.type(first(yieldDescendants.ofClass(Name.class).suchThat(λ -> "x".equals(λ + "") && iz.methodInvocation(λ.getParent()))
  ...
  @Test public void d() {
    azzert.that(analyze.type(first(yieldDescendants.ofClass(Name.class).suchThat(λ -> "x".equals(λ + ""))
