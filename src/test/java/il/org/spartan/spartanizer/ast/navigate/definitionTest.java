...
@annotation @Target({ ElementType.METHOD }) @interface annotationMemberDeclaration { /**/ }
  @annotation @Target({ ElementType.METHOD, ElementType.PARAMETER, ElementType.LOCAL_VARIABLE }) @interface catch¢ { /**/ }
  @annotation @Target({ ElementType.LOCAL_VARIABLE, ElementType.ANNOTATION_TYPE, ElementType.METHOD, ElementType.TYPE }) @interface class¢ { /**/ }
  ...
  @class¢ @scopeSize(22) class DummycClass { /**/}
  @enum¢ @scopeSize(22) enum DummyEnum { /**/ }
  @interface¢ @scopeSize(22) interface DummyInterface {/**/ }
