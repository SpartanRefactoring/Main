...
public class Issue1070 {
  @Test public void b1() {
    trimmingOf(
        "while(b) {" + "z=1;" + "switch(x) {" + "case 1: y = 1; break;" + "case 2: y = 2; break;" + "case 3: default: case 5: continue;" + "}" + "}")
  ...
  @Test public void t2() {
    trimmingOf("void apply(int x) {" + "switch(y) {" + "case 1: x=2; break;" + "case 2: y=3; break;" + "default: return;" + "}" + "z = 1;" + "}")
        .stays();
  }
