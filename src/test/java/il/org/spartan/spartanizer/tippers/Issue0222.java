...
public class Issue0222 {
 @Test public void chocolate1(){
  trimmingOf("L<E> os(I x){if(x==null)return null;int y=x;++y;"
    + " L<E> $=new A<>();$.a(l(x));$.a(r(x));if(x.h())"
    + " $.d(s.es(x));return $;}")//
      .stays();
 }
 ...
 @Test public void chocolate3(){
  trimmingOf("int f(int i){for(int b: fs)return 0;return 1;}")
    .gives("int f(int __){for(int b: fs)return 0;return 1;}")//
    .stays();
 }
 ...
 @Test public void vanilla(){
  trimmingOf("L<E> os(I x){if(x==null)return null;L<E> $=new A<>();$.a(l(x));$.a(r(x));if(x.h())$.d(s.es(x));return $;}")
      .gives("L<E> os(I ¢){if(¢==null)return null;L<E> $=new A<>();$.a(l(¢));$.a(r(¢));if(¢.h())$.d(s.es(¢));return $;}")
      .stays();
 }
}
