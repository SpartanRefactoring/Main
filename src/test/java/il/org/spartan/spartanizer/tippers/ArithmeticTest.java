...
public final class ArithmeticTest {
  public static class Working {
    ...
    @Test public void issue143_1() {
      trimmingOf("1*31").gives("31").stays();
    }
    ...
    @Test public void issue92_1() {
      trimmingOf("1.+2*3 / 4 - 5").gives("2*3/4+1.-5").gives("6/4+1.-5").gives("1+1.-5").gives("2.0-5").gives("-3.0").stays();
    }
    @Test public void issue92_10() {
      trimmingOf("2+3*4").gives("3*4+2").gives("12+2").gives("14").stays();
    }
    @Test public void issue92_11() {
      trimmingOf("100-49").gives("51").stays();
    }
    @Test public void issue92_12() {
      trimmingOf("1-2").gives("-1").stays();
    }
    @Test public void issue92_13() {
      trimmingOf("-9*2").gives("-18").stays();
    }
    @Test public void issue92_14() {
      trimmingOf("9*6-4").gives("54-4").gives("50").stays();
    }
    @Test public void issue92_15() {
      trimmingOf("4 + -9").gives("4-9").gives("-5").stays();
    }
    @Test public void issue92_16() {
      trimmingOf("4 * -9").gives("-36").stays();
    }
    @Test public void issue92_17() {
      trimmingOf("4 * -9 * -1").gives("36").stays();
    }
    @Test public void issue92_18() {
      trimmingOf("4*-9 + 5*5").gives("5*5 -4*9").gives("25-36").gives("-11").stays();
    }
    ...
    @Test public void issue92_21() {
      trimmingOf("5*5+6*7-9").gives("25+42-9").gives("67-9").gives("58").stays();
    }
    @Test public void issue92_22() {
      trimmingOf("12/3").gives("4").stays();
    }
    @Test public void issue92_23() {
      trimmingOf("12/5").gives("2").stays();
    }
    ...
    @Test public void issue92_26() {
      trimmingOf("12/-5/2").gives("-1").stays();
    }
    @Test public void issue92_27() {
      trimmingOf("1.0+2.0").gives("3.0").stays();
    }
    @Test public void issue92_28() {
      trimmingOf("1.9+2.2").gives("4.1").stays();
    }
    @Test public void issue92_29() {
      trimmingOf("1+2.2").gives("3.2").stays();
    }
    @Test public void issue92_3() {
      trimmingOf("1+1+3").gives("5").stays();
    }
    @Test public void issue92_30() {
      trimmingOf("1.+1.").gives("2.0").stays();
    }
    @Test public void issue92_31() {
      trimmingOf("2*1.0").gives("2.0").stays();
    }
    @Test public void issue92_32() {
      trimmingOf("4-5.0").gives("-1.0").stays();
    }
    @Test public void issue92_33() {
      trimmingOf("5 *-9.0 +3").gives("3-5*9.0").gives("3-45.0").gives("-42.0").stays();
    }
    @Test public void issue92_34() {
      trimmingOf("-a+5").gives("5-a").stays();
    }
    @Test public void issue92_35() {
      trimmingOf("100/2/5").gives("10").stays();
    }
    @Test public void issue92_36() {
      trimmingOf("100L+2L").gives("102L").stays();
    }
    @Test public void issue92_37() {
      trimmingOf("100L+2.0").gives("102.0").stays();
    }
    @Test public void issue92_38() {
      trimmingOf("100L+2+1.0").gives("103.0").stays();
    }
    @Test public void issue92_39() {
      trimmingOf("100L*2+1.0").gives("200L+1.0").gives("201.0").stays();
    }
    @Test public void issue92_4() {
      trimmingOf("1+1+3").gives("5").stays();
    }
    @Test public void issue92_40() {
      trimmingOf("100L*9.0").gives("900.0").stays();
    }
    @Test public void issue92_41() {
      trimmingOf("100L-9L").gives("91L").stays();
    }
    @Test public void issue92_42() {
      trimmingOf("100L-9.0").gives("91.0").stays();
    }
    @Test public void issue92_43() {
      trimmingOf("100L-9").gives("91L").stays();
    }
    @Test public void issue92_44() {
      trimmingOf("100L/2").gives("50L").stays();
    }
    @Test public void issue92_45() {
      trimmingOf("100L/10.0").gives("10.0").stays();
    }
    @Test public void issue92_46() {
      trimmingOf("1.+2*3 / 4 - 5*48L").gives("2*3/4+1.-240L").gives("6/4+1.-240L").gives("1+1.-240L").gives("2.0-240L").gives("-238.0").stays();
    }
    @Test public void issue92_47() {
      trimmingOf("10%2").gives("0").stays();
    }
    @Test public void issue92_48() {
      trimmingOf("10%3").gives("1").stays();
    }
    @Test public void issue92_49() {
      trimmingOf("10L%3").gives("1L").stays();
    }
    @Test public void issue92_5() {
      trimmingOf("5.*5.").gives("25.0").stays();
    }
    @Test public void issue92_50() {
      trimmingOf("100L%3%1").gives("0L").stays();
    }
    ...
    @Test public void issue92_61() {
      trimmingOf("-1.0/-2*-3/-4*-5*-6/-7/-8/-9").gives("-1.0/2*3/4*5*6/7/8/9").gives("-1.0/2*3/4*30/7/8/9").gives("30*-1.0/2*3/4/7/8/9")
          .gives("3*30*-1.0/2/4/7/8/9").gives("-90.0/2/4/7/8/9").gives("-0.022321428571428572").stays();
    }
    @Test public void issue92_62() {
      trimmingOf("1.984+0.006").gives("1.99").stays();
    }
    @Test public void issue92_7() {
      trimmingOf("1L*2+1L*99").gives("2L+99L").gives("101L").stays();
    }
    @Test public void issue92_8() {
      trimmingOf("3*4*2").gives("24").stays();
    }
