...
final class ArithmeticTest {
  public static class Working {
    ...
    @Test public void issue143_1() {
      topDownTrimming("1*31")//
          .gives("31")//
          .stays();
    }

    @Test public void issue143_2() {
      topDownTrimming("return ((31 * 1 + ((blockScope == null) ? 0 : blockScope.hashCode())) * 31"
    ...
    @Test public void issue158_1() {
      topDownTrimming("wizard.assertEquals(5 / 9.0, s_4x0_5x1.mean(), 1E-6);")//
          .stays();
    }

    @Test public void issue158_2() {
      topDownTrimming("wizard.assertEquals(5 / 1, s_4x0_5x1.mean(), 1E-6);")//
          .gives("wizard.assertEquals(5, s_4x0_5x1.mean(), 1E-6);")//
          .stays();
    }

    @Test public void issue158_3() {
      topDownTrimming("wizard.assertEquals(99*2, s_4x0_5x1.mean(), 1E-6);")//
    ...
    @Test public void issue171_3() {
      topDownTrimming("p%3%r")//
          .stays();
    }

    @Test public void issue171_4() {
      topDownTrimming("p+q+w-9*4")//
          .gives("p+q+w-36")//
          .stays();
    }

    @Test public void issue171_5() {
      topDownTrimming("5L%p+q+w-9*4")//
          .gives("q+w+5L%p-36")//
          .stays();
    }

    @Test public void issue171_6() {
      topDownTrimming("5L%6.")//
          .stays();
    }
    ...
    @Test public void issue171_8() {
      topDownTrimming("5%6.F")//
          .stays();
    }

    @Test public void issue201_1() {
      topDownTrimming("(long) (1L * ++d * f--)")//
          .stays();
    }

    @Test public void issue206_1() {
      topDownTrimming("3+4+a")//
          .gives("7+a")//
          .stays();
    }

    @Test public void issue206_10() {
      topDownTrimming("1L*1L*a*b*c")//
          .gives("1L*a*b*c")//
          .stays();
    }
    ...
    @Test public void issue206_12() {
      topDownTrimming("8%3%a")//
          .gives("2%a")//
          .stays();
    }

    @Test public void issue206_13() {
      topDownTrimming("a%8%3")//
          .stays();
    }
    ...
    @Test public void issue206_4() {
      topDownTrimming("5/1/a")//
          .gives("5/a")//
          .stays();
    }

    @Test public void issue206_5() {
      topDownTrimming("a+8+9")//
          .gives("a+17")//
          .stays();
    }
    ...
    @Test public void issue206_7() {
      topDownTrimming("a-8-2-2")//
          .gives("a-4")//
          .stays();
    }

    @Test public void issue206_8() {
      topDownTrimming("a-8-2L-2")//
          .gives("a-4L")//
          .stays();
    }

    @Test public void issue206_9() {
      topDownTrimming("a-8-2L-2.0")//
          .gives("a-4.0")//
          .stays();
    }

    @Test public void issue92_1() {
      topDownTrimming("1.+2*3 / 4 - 5")//
          .gives("2*3/4+1.-5")//
          .gives("6/4+1.-5")//
          .gives("1+1.-5")//
          .gives("2.0-5")//
    ...
    @Test public void issue92_17() {
      topDownTrimming("4 * -9 * -1")//
          .gives("36")//
          .stays();
    }

    @Test public void issue92_18() {
      topDownTrimming("4*-9 + 5*5")//
          .gives("5*5 -4*9")//
          .gives("25-36")//
          .gives("-11")//
          .stays();
    ...
    @Test public void issue92_22() {
      topDownTrimming("12/3")//
          .gives("4")//
          .stays();
    }

    @Test public void issue92_23() {
      topDownTrimming("12/5")//
          .gives("2")//
          .stays();
    }
    ...
    @Test public void issue92_26() {
      topDownTrimming("12/-5/2")//
          .gives("-1")//
          .stays();
    }

    @Test public void issue92_27() {
      topDownTrimming("1.0+2.0")//
          .gives("3.0")//
          .stays();
    }

    @Test public void issue92_28() {
      topDownTrimming("1.9+2.2")//
          .gives("4.1")//
          .stays();
    }

    @Test public void issue92_29() {
      topDownTrimming("1+2.2")//
          .gives("3.2")//
          .stays();
    }

    @Test public void issue92_3() {
      topDownTrimming("1+1+3")//
          .gives("5")//
          .stays();
    }
    ...
    @Test public void issue92_31() {
      topDownTrimming("2*1.0")//
          .gives("2.0")//
          .stays();
    }

    @Test public void issue92_32() {
      topDownTrimming("4-5.0")//
          .gives("-1.0")//
          .stays();
    }

    @Test public void issue92_33() {
      topDownTrimming("5 *-9.0 +3")//
          .gives("3-5*9.0")//
          .gives("3-45.0")//
          .gives("-42.0")//
          .stays();
    ...
    @Test public void issue92_37() {
      topDownTrimming("100L+2.0")//
          .gives("102.0")//
          .stays();
    }

    @Test public void issue92_38() {
      topDownTrimming("100L+2+1.0")//
          .gives("103.0")//
          .stays();
    }
    ...
    @Test public void issue92_40() {
      topDownTrimming("100L*9.0")//
          .gives("900.0")//
          .stays();
    }

    @Test public void issue92_41() {
      topDownTrimming("100L-9L")//
          .gives("91L")//
          .stays();
    }
    ...
    @Test public void issue92_45() {
      topDownTrimming("100L/10.0")//
          .gives("10.0")//
          .stays();
    }

    @Test public void issue92_46() {
      topDownTrimming("1.+2*3 / 4 - 5*48L")//
          .gives("2*3/4+1.-240L")//
          .gives("6/4+1.-240L")//
          .gives("1+1.-240L")//
          .gives("2.0-240L")//
    ...
    @Test public void issue92_47() {
      topDownTrimming("10%2")//
          .gives("0")//
          .stays();
    }

    @Test public void issue92_48() {
      topDownTrimming("10%3")//
          .gives("1")//
          .stays();
    }

    @Test public void issue92_49() {
      topDownTrimming("10L%3")//
          .gives("1L")//
          .stays();
    }
    ...
    @Test public void issue92_50() {
      topDownTrimming("100L%3%1")//
          .gives("0L")//
          .stays();
    }

    @Test public void issue92_51() {
      topDownTrimming("100%3L%1")//
          .gives("0L")//
          .stays();
    }

    @Test public void issue92_53() {
      topDownTrimming("-1/-2*-3/-4*-5*-6/-7/-8/-9")//
    ...
    @Test public void issue92_61() {
      topDownTrimming("-1.0/-2*-3/-4*-5*-6/-7/-8/-9")//
    ...
    @Test public void issue92_62() {
      topDownTrimming("1.984+0.006")//
          .gives("1.99")//
          .stays();
    }

    @Test public void issue92_7() {
      topDownTrimming("1L*2+1L*99")//
          .gives("2L+99L")//
          .gives("101L")//
          .stays();
    }
    ...
    @Test public void sanity() {
      topDownTrimming("10/2/1L")//
          .gives("5L");
    }

    @Test public void sanity2() {
      topDownTrimming("10/2/1.")//
          .gives("5.0");
    }

    @Test public void sanity3() {
      topDownTrimming("10/2/0L")//
          .stays();
    }
  }
}
