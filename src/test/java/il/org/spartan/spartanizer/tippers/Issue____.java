 ...
 * <p>
 * You can augment
 * <code><b>assert</b> with a short                                          {@link Object}                                           (usually a                                           {@link String}                                          ) that can provide some debugging information (see the implementation of                                          {@link #Z$040()}                                           or                                           {@link #Z$060()}                                          .) <li>Instead, use class                                           {@link azzert}                                           for anything else: <ul>  <li> to check whether something is <code><b>null</b></code>,
 ...
 * </ol>
 * @author Yossi Gil
 *         {@code yossi dot (optional) gil at gmail dot (required) com} // put
 *         your name here
