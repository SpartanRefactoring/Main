...
public class Issue716 {
  @Test public void checkElevenStatements() {
    assert determineIf.hasManyStatements((MethodDeclaration) wizard
  ...
  @Test public void checkFiveStatements() {
    assert !determineIf.hasManyStatements((MethodDeclaration) wizard.ast("public void fiveStatements() {int a; int b; int c; int d; int e;}"));
  }
  ...
  @Test public void checkNoStatements() {
    assert !determineIf.hasManyStatements((MethodDeclaration) wizard.ast("public void noStatements() { }"));
  }
