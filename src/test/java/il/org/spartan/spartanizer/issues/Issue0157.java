...
public final class Issue0157 {
  @Test public void test01() {
    topDownTrimming("public static String combine(final Cla$<?>[] cla$es) {  \n" //
  ...
  @Test public void test02() {
    topDownTrimming("public static String combine(final Uno<?>[] uno) {  \n" //
  ...
  @Test public void test03() {
    topDownTrimming("public static String combine(final Many<?>[] manies) {  \n" //
  ...
  @Test public void test04() {
    topDownTrimming("public static String combine(final Many<? extends Few>[] fews) {  \n" //
  ...
  @Test public void test05() {
    topDownTrimming("public static String combine(final Many<? super Few>[] fews) {  \n" //
        + "final String[] $ = new String[fews.length];  \n" //
        + "for (int i = 0; i <$.length; ++i)  \n" //
        + "$[i] = fews[i] == null ? null : fews[i].getName(); \n" //
        + "return combine($);  \n" //
  ...
  @Test public void test06() {
    topDownTrimming("public static String combine(final Many<Paranoid> paranoid) {  \n" //
  ...
  @Test public void test07() {
    topDownTrimming("public static String combine(final List<Paranoid> paranoid) {  \n" //
  ...
  @Test public void test08() {
    topDownTrimming("public static String combine(final Set<Paranoid> paranoid) {  \n" //
  ...
  @Test public void test09() {
    topDownTrimming("public static String combine(final Set<List<HashSet<?>[]>> hash) {  \n" //
