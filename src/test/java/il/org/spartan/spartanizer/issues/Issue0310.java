...
public class Issue0310 {
  @Test public void OrisCode_k() {
    topDownTrimming("void foo(){int i=0;for(;i<10;++i)if(i=5)return;}")//
  ...
  @Test public void updaters_for_1() {
    topDownTrimming("boolean k(final N n){N p=n;for(;p!=null;){if(Z.z(p))return true;p=p.f();}return false;}")
  ...
  @Test public void xooleanaFinalAbForAcbcNullIfBdcReturnTruecceReturnFalse() {
    topDownTrimming("boolean a(final A b) { for (A c = b; c != null;) { if (B.d(c)) return true; c = c.e(); } return false; }") //
  ...
  @Test public void updaters_for_2() {
    topDownTrimming("boolean k(final N n){N p=n;for(;p!=null;){if(Z.z(p))return true;if(ens.z(p))return true;p=p.f();}return false;}")
  ...
  @Test public void updaters_for_3a() {
    topDownTrimming("for(int i=0;i<10;){int x=1;i+=x;x=5;}")//
        .stays();
  }

  @Test public void updaters_for_3b() {
    topDownTrimming("for(int i=0;i<10;){int x=1;i+=x;}")//
  ...
  @Test public void updaters_for_4() {
    topDownTrimming("boolean k(final N n){for(N p=n;p!=null;){if(Z.z(p))return true;++i;++j;}return false;}")//
        .stays();
  }

  @Test public void updaters_ordering_check_1_b() {
    topDownTrimming("for(int i=0;;){arr[i]=0;++i;}")//
  ...
  @Test public void updaters_ordering_check_2_right() {
    topDownTrimming("List<M> ms=new U<>();M m=ms.gt(0);for(int i=0;;){m=ms.gt(i);++i;}")
  ...
  @Test public void test_booleanaFinalAbForAcbcNullIfBdcReturnTrueIfedcReturnTrueccfReturnFalse() {
    topDownTrimming("boolean a(final A b) { for (A c = b; c != null;) { if (B.d(c)) return true; if (e.d(c)) return true; c = c.f(); } return false; }") //
        .using(ForStatement.class, new ForToForUpdaters()) //
  ...
  @Test public void updaters_while_3() {
    topDownTrimming("boolean k(final N n){N p=n;while(p!=null){if(Z.z(p))return true;f();}return false;}")
        .gives("boolean k(final N n){for(N p=n;p!=null;){if(Z.z(p))return true;f();}return false;}")//
        .stays();
  }

  @Test public void updaters_while_4() {
    topDownTrimming("boolean k(final N n){N p=n;while(p!=null){if(Z.z(p))return true;++i;}return false;}")
