...
public class Issue0879 {
  ...
  @Test public void daIntb4Ifb3b3b4Elseb5b55Return() {
    topDownTrimming("void a() { int b = 4; if (b > 3) { b += 3; b += 4; } else { b += 5; b += 55; } return; }") //
  ...
  @Test public void test_intaIntb9Intc7b4cbbReturnc() {
    topDownTrimming("int a() { int b = 9; int c = 7; b += 4; c = b + b; return c; }") //
  ...
  @Test public void test3() {
    topDownTrimming("void f(){int x=9;int y=7; x+=4;y=x+x;return;}")//
