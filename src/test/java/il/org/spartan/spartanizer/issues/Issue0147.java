...
public class Issue0147 {
  ...
  @Test public void a$() {
    trimminKof("for(int ¢=0; ¢<5;++¢){x.fuanc(); if(bool) continue;}")//
        .stays();
  }

  @Test public void b() {
    trimminKof("for (final Object o : os) {if (bool) return; continue;}")//
        .gives("for (final Object o : os) {if (bool) return; }");//
  }

  @Test public void b$() {
    trimminKof("for(final Object o : os){x.fuanc(); if(bool) continue;}")//
        .stays();
  }
