...
public class Issue0141 {
  @Test public void b$01() {
    topDownTrimming("public static void go(final Object os[], final String... ss) {  \nfor (final String saa : ss) \nout(saa);  \n"
        + "out(\"elements\", os);   \n}")//
            .stays();
  }

  @Test public void b$02() {
    topDownTrimming("public static void go(final List<Object> os, final String... ss) {  \nfor (final String saa : ss) \nout(saa);  \n"
        + "out(\"elements\", os);   \n}")//
            .stays();
  }

  @Test public void b$03() {
    topDownTrimming("public static void go(final String ss[],String abracadabra) {  \nfor (final String a : ss) \nout(a);  \n"
        + "out(\"elements\",abracadabra);   \n}")//
            .stays();
  }

  @Test public void b$04() {
    topDownTrimming("public static void go(final String ss[]) {  \nfor (final String a : ss) \nout(a);  \nout(\"elements\");   \n}").stays();
  }

  @Test public void b$05() {
    topDownTrimming("public static void go(final String s[]) {  \nfor (final String a : s) \nout(a);  \nout(\"elements\");   \n}")
