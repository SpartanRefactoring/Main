...
public class Issue1218 {
  @Test public void a0() {
    topDownTrimming("int a(){int $=13;return $;}") //
  ...
  @Test public void a2() {
    topDownTrimming("int k=1;return 0<k;")//
        .gives("return 0<1;");
  }
  ...
  @Test public void inta5b2c4Return3bac() {
    topDownTrimming("int a = 5, b = 2, c = 4; return 3 * b * a * c;") //
        .using(VariableDeclarationFragment.class, new LocalInitializedReturnExpression()) //
  ...
  @Test public void a4() {
    topDownTrimming("int a=2;return 3*a*4;")//
        .gives("return 3 * 2 * 4;");
  }
