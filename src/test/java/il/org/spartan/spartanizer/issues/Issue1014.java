...
public class Issue1014 {
  @Test public void test0() {
    topDownTrimming("for (final MarkerAnnotation a : new definitionTest().markers()) {final String key = (a + \"\").substring(1);"
  ...
  @Test public void test1() {
    topDownTrimming("for (int i=0 ;i<length;++i){int a;if(a==b)continue; c= a+3;}") //
        .gives("for (int i=0 ;i<length;++i){int a;if(a!=b)c=a+3;}")//
        .stays();
  }

  @Test public void test2() {
    topDownTrimming("while (q){int a;if(a==b)continue; c= a+3;}") //
