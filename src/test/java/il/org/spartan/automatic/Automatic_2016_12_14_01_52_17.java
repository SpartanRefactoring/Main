...
public class Automatic_2016_12_14_01_52_17 {
  ...
  @Test public void nextPrefixTest() {
    topDownTrimming("package a;public final class A {  public void b(){    try {      B.c(d).e().f(g -> h[i++]=j(g));    }"
  ...
  @Test public void redundanciesTest() {
    topDownTrimming("package a;public final class A {  public void b(){    for (    final B c : d)     if (c.e(f))     f=c;  }}").doesNotCrash();
  }
  ...
  @Test public void replacement3Test() {
    topDownTrimming("package a;public final class A {	public void b() {		int c = d;		d = e;		return c;	}}").doesNotCrash();
  }
  ...
  @Test public void replacementTest() {
    topDownTrimming("package a;public final class A {	public void b() {		if (c == null)			return;		d();		d();	}}").doesNotCrash();
  }
}
