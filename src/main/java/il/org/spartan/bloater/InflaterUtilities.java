...
public enum InflaterUtilities {
  ...
  @NotNull static List<ASTNode> getStatements(@NotNull final WrappedCompilationUnit u) {
    ...
    u.compilationUnit.accept(new ASTVisitor(true) {
      ...
      @Override public boolean visit(@NotNull final ExpressionStatement node) {
  ...
  static List<ASTNode> selectedStatements(@NotNull final Collection<ASTNode> ns) {
  ...
  public static void aux_go(@NotNull final CompilationUnit u, final OperationsProvider p) {
