...
// * @since 03-12-2016
// */
// public final class WhileNextReturnToWhile extends EagerTipper<WhileStatement>
// implements TipperCategory.Inlining {
// @Override public String description(@SuppressWarnings("unused") final
// WhileStatement ¢) {
...
// int breaks = new Recurser<>(n,0).preVisit((x) ->
// (iz.breakStatement(az.statement(x.getRoot())) ? (1 + x.getCurrent()) :
// x.getCurrent()));
