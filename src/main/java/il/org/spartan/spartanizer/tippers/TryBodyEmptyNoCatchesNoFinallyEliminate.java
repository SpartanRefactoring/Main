...
/** convert pattern <code>try {s} [ finally { <i>empty</i> }]</code>, <code>s</code> not empty, to <code>{s}</code>.
 * @author Yossi Gil <tt>yossi.gil@gmail.com</tt>
 * @since 2017-01-19 */
public final class TryBodyEmptyNoCatchesNoFinallyEliminate extends RemovingTipper<TryStatement> implements TipperCategory.Collapse {
