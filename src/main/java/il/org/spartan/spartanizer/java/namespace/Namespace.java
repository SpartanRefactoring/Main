...
public final class Namespace implements Environment {
  ...
  /**
   * A constructor which get only the environment and a name of the NameSpace
   */
  ...
  /**
   * Add to the NameSpace a new name according to its type,
   * we habdle each kind of node with a different function
   */
