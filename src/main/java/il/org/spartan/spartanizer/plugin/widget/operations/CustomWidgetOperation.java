...
public class CustomWidgetOperation extends WidgetOperation {
  ...
  /** configuration should be Map<?,String>. 
   * configuration.values() should be Collection<String> that includes
   * the commands the user configured. The keys associated with the values does not matter. 
   */
