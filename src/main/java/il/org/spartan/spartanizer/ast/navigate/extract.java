...
public enum extract {
  ...
  @Nullable public static List<String> usedNames(final Expression x) {
    return new ExpressionBottomUp<List<String>>() {
      ...
      @Override @Nullable public List<String> reduce(@Nullable final List<String> ss1, @Nullable final List<String> ss2) {
      ...
      @Override @NotNull protected List<String> map(@NotNull final SimpleName ¢) {
        final String $ = ¢.getIdentifier();
        return guessName.of($) != guessName.METHOD_OR_VARIABLE ? reduce() : as.list($);
      }

      @Override @NotNull protected List<String> map(@SuppressWarnings("unused") final ThisExpression ¢) {
        return reduce();
      }
    }.map(x);
  }
  ...
  @NotNull public static List<ASTNode> updatedVariables(final Expression x) {
    @Nullable final List<ASTNode> $ = new ExpressionBottomUp<List<ASTNode>>() {
      ...
      @Override @Nullable public List<ASTNode> reduce(@Nullable final List<ASTNode> l1, @Nullable final List<ASTNode> l2) {
        if (l1 == null)
          return l2;
        if (l2 == null)
          return l1;
      ...
      @Override @Nullable protected List<ASTNode> map(final Assignment ¢) {
      ...
      @Override @Nullable protected List<ASTNode> map(@NotNull final PrefixExpression ¢) {
