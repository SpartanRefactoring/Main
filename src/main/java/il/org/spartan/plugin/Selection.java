...
public class Selection extends AbstractSelection<Selection> {
  ...
  public static class Util {
    ...
    private static String getMultiSelectionName(final List<MarkerItem> is, final List<IJavaProject> ps, final List<IPackageFragmentRoot> rs, final List<IPackageFragment> hs,
        final List<ICompilationUnit> us, final List<IMember> ms) {
