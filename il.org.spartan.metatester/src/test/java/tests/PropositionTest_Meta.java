...
OR(F,T).and(T).eval();
OR(F,T).and(T).or(X).eval();
assertThat(!OR(F,T).and(T).and(F).eval()).isTrue();}@Test public void b2_meta154(){
...
azzert.that(F.and("X1",X).or(T).reduce(javaReducer),is("((F && X1) || T)"));
azzert.that(F.or("X1",X).or(T).reduce(javaReducer),is("(F || X1 || T)"));}
@Test public void b2_meta156(){
azzert.that(T_OR_F_OR_X + "",is("T OR F OR X"));
azzert.that(F.or(T).and(T).reduce(javaReducer),is("((F || T) && T)"));
azzert.that(F.and(X).or(T).reduce(javaReducer),is("((F && X) || T)"));
azzert.that(F.and("X1",X).or(T).reduce(javaReducer),is("((F && X1) || T)"));
azzert.that(F.or("X1",X).or(T).reduce(javaReducer),is("(F || X1 || T)"));}
@Test public void b2_meta157(){
azzert.that(T_OR_F_OR_X + "",is("T OR F OR X"));
azzert.that(F.or(T).and(T).reduce(javaReducer),is("((F || T) && T)"));
assertThat(javaReducer).isNotNull();
azzert.that(F.and(X).or(T).reduce(javaReducer),is("((F && X) || T)"));
azzert.that(F.and("X1",X).or(T).reduce(javaReducer),is("((F && X1) || T)"));
azzert.that(F.or("X1",X).or(T).reduce(javaReducer),is("(F || X1 || T)"));}
@Test public void b2_meta158(){
azzert.that(T_OR_F_OR_X + "",is("T OR F OR X"));
azzert.that(F.or(T).and(T).reduce(javaReducer),is("((F || T) && T)"));
azzert.that(F.and(X).or(T).reduce(javaReducer),is("((F && X) || T)"));
azzert.that(F.and("X1",X).or(T).reduce(javaReducer),is("((F && X1) || T)"));
azzert.that(F.or("X1",X).or(T).reduce(javaReducer),is("(F || X1 || T)"));}
@Test public void b2_meta159(){
azzert.that(T_OR_F_OR_X + "",is("T OR F OR X"));
azzert.that(F.or(T).and(T).reduce(javaReducer),is("((F || T) && T)"));
azzert.that(F.and(X).or(T).reduce(javaReducer),is("((F && X) || T)"));
assertThat(javaReducer).isNotNull();
azzert.that(F.and("X1",X).or(T).reduce(javaReducer),is("((F && X1) || T)"));
azzert.that(F.or("X1",X).or(T).reduce(javaReducer),is("(F || X1 || T)"));}
@Test public void b2_meta160(){
azzert.that(T_OR_F_OR_X + "",is("T OR F OR X"));
azzert.that(F.or(T).and(T).reduce(javaReducer),is("((F || T) && T)"));
azzert.that(F.and(X).or(T).reduce(javaReducer),is("((F && X) || T)"));
azzert.that(F.and("X1",X).or(T).reduce(javaReducer),is("((F && X1) || T)"));
azzert.that(F.or("X1",X).or(T).reduce(javaReducer),is("(F || X1 || T)"));}
@Test public void b2_meta161(){
azzert.that(T_OR_F_OR_X + "",is("T OR F OR X"));
azzert.that(F.or(T).and(T).reduce(javaReducer),is("((F || T) && T)"));
azzert.that(F.and(X).or(T).reduce(javaReducer),is("((F && X) || T)"));
azzert.that(F.and("X1",X).or(T).reduce(javaReducer),is("((F && X1) || T)"));
assertThat(javaReducer).isNotNull();
azzert.that(F.or("X1",X).or(T).reduce(javaReducer),is("(F || X1 || T)"));}
@Test public void b2_meta162(){
azzert.that(T_OR_F_OR_X + "",is("T OR F OR X"));
azzert.that(F.or(T).and(T).reduce(javaReducer),is("((F || T) && T)"));
azzert.that(F.and(X).or(T).reduce(javaReducer),is("((F && X) || T)"));
azzert.that(F.and("X1",X).or(T).reduce(javaReducer),is("((F && X1) || T)"));
azzert.that(F.or("X1",X).or(T).reduce(javaReducer),is("(F || X1 || T)"));}@Test public void b2a_meta163(){
assertThat(javaReducer).isNotNull();
azzert.that(OR(F,X,N).and(T).reduce(javaReducer),is("((F || X || N) && T)"));}
@Test public void b2a_meta164(){
azzert.that(OR(F,X,N).and(T).reduce(javaReducer),is("((F || X || N) && T)"));}@Test public void b3_meta165(){
...
@Test public void b3_meta168(){
assertThat(!hasCycles(N)).isTrue();}
@Test public void b3_meta169(){
assertThat(!hasCycles(T.and(F))).isTrue();}
@Test public void b3_meta170(){
assertThat(!hasCycles(F.and(T))).isTrue();}
@Test public void b3_meta171(){
assertThat(!hasCycles(T.and(T))).isTrue();}
@Test public void b3_meta172(){
assertThat(!hasCycles(T.or(T))).isTrue();}
@Test public void b3_meta173(){
assertThat(!hasCycles(T_AND_F_AND_X)).isTrue();}
@Test public void b3_meta174(){
assertThat(!hasCycles(T_OR_F_OR_X)).isTrue();}@Test public void b31_meta175(){
assertThat(!hasCycles(T.or(T))).isTrue();}@Test public void b32_meta176(){
assertThat(!hasCycles(T.and(T))).isTrue();}@Test public void b4_meta177(){
assertThat(javaReducer).isNotNull();
T.reduce(javaReducer);}
@Test public void b4_meta178(){
T.reduce(javaReducer);}@Test public void b5_meta179(){
assertThat(javaReducer).isNotNull();
F.and(F).reduce(javaReducer);}
@Test public void b5_meta180(){
F.and(F).reduce(javaReducer);}@Test public void b8_meta181(){
assertThat(javaReducer).isNotNull();
T.or(X).reduce(javaReducer);}
@Test public void b8_meta182(){
T.or(X).reduce(javaReducer);}@Test public void b9_meta183(){
assertThat(javaReducer).isNotNull();
...
@Test public void b9_meta184(){
azzert.that(X.reduce(javaReducer),instanceOf(String.class));
azzert.that(X.reduce(javaReducer),is("X"));
azzert.that(T.reduce(javaReducer),is("T"));
azzert.that(T.or(X).reduce(javaReducer),is("(T || X)"));}
@Test public void b9_meta185(){
azzert.that(X.reduce(javaReducer),instanceOf(String.class));
assertThat(javaReducer).isNotNull();
azzert.that(X.reduce(javaReducer),is("X"));
azzert.that(T.reduce(javaReducer),is("T"));
azzert.that(T.or(X).reduce(javaReducer),is("(T || X)"));}
@Test public void b9_meta186(){
azzert.that(X.reduce(javaReducer),instanceOf(String.class));
azzert.that(X.reduce(javaReducer),is("X"));
azzert.that(T.reduce(javaReducer),is("T"));
azzert.that(T.or(X).reduce(javaReducer),is("(T || X)"));}
@Test public void b9_meta187(){
azzert.that(X.reduce(javaReducer),instanceOf(String.class));
azzert.that(X.reduce(javaReducer),is("X"));
assertThat(javaReducer).isNotNull();
azzert.that(T.reduce(javaReducer),is("T"));
azzert.that(T.or(X).reduce(javaReducer),is("(T || X)"));}
@Test public void b9_meta188(){
azzert.that(X.reduce(javaReducer),instanceOf(String.class));
azzert.that(X.reduce(javaReducer),is("X"));
azzert.that(T.reduce(javaReducer),is("T"));
azzert.that(T.or(X).reduce(javaReducer),is("(T || X)"));}
@Test public void b9_meta189(){
azzert.that(X.reduce(javaReducer),instanceOf(String.class));
azzert.that(X.reduce(javaReducer),is("X"));
azzert.that(T.reduce(javaReducer),is("T"));
assertThat(javaReducer).isNotNull();
azzert.that(T.or(X).reduce(javaReducer),is("(T || X)"));}
@Test public void b9_meta190(){
azzert.that(X.reduce(javaReducer),instanceOf(String.class));
azzert.that(X.reduce(javaReducer),is("X"));
azzert.that(T.reduce(javaReducer),is("T"));
azzert.that(T.or(X).reduce(javaReducer),is("(T || X)"));}@Test public void b91_meta191(){
assertThat(javaReducer).isNotNull();
azzert.that(T.and(X).reduce(javaReducer),is("(T && X)"));}
@Test public void b91_meta192(){
azzert.that(T.and(X).reduce(javaReducer),is("(T && X)"));}@Test public void b92_meta193(){
assertThat(javaReducer).isNotNull();
azzert.that(not(T).reduce(javaReducer),is("!T"));}
@Test public void b92_meta194(){
azzert.that(not(T).reduce(javaReducer),is("!T"));}@Test public void b93_meta195(){
assertThat(javaReducer).isNotNull();
azzert.that(not(X).reduce(javaReducer),is("!X"));}
@Test public void b93_meta196(){
azzert.that(not(X).reduce(javaReducer),is("!X"));}@Test public void b94_meta197(){
assertThat(javaReducer).isNotNull();
azzert.that(not(N).reduce(javaReducer),is("!N"));}
@Test public void b94_meta198(){
azzert.that(not(N).reduce(javaReducer),is("!N"));}@Test public void b95_meta199(){
assertThat(javaReducer).isNotNull();
azzert.that(that(T).reduce(javaReducer),is("T"));}
@Test public void b95_meta200(){
azzert.that(that(T).reduce(javaReducer),is("T"));}@Test public void d_meta201(){
assertThat(javaReducer).isNotNull();
azzert.that(T_OR_F_OR_X.reduce(javaReducer),is("(T || F || X)"));}
@Test public void d_meta202(){
azzert.that(T_OR_F_OR_X.reduce(javaReducer),is("(T || F || X)"));}@Test public void d0_meta203(){
assertThat(javaReducer).isNotNull();
T.or(X,X).reduce(javaReducer);
azzert.that(T.or(X,X).reduce(javaReducer),is("(T || X || X)"));}
@Test public void d0_meta204(){
T.or(X,X).reduce(javaReducer);
azzert.that(T.or(X,X).reduce(javaReducer),is("(T || X || X)"));}
@Test public void d0_meta205(){
T.or(X,X).reduce(javaReducer);
assertThat(javaReducer).isNotNull();
azzert.that(T.or(X,X).reduce(javaReducer),is("(T || X || X)"));}
@Test public void d0_meta206(){
T.or(X,X).reduce(javaReducer);
azzert.that(T.or(X,X).reduce(javaReducer),is("(T || X || X)"));}@Test public void d1_meta207(){
...
),is("TFX"));}@Test public void e_meta208(){
assertThat(javaReducer).isNotNull();
azzert.that(T_AND_F_AND_X.reduce(javaReducer),is("(T && F && X)"));}
@Test public void e_meta209(){
azzert.that(T_AND_F_AND_X.reduce(javaReducer),is("(T && F && X)"));}@Test public void f_meta210(){
assertThat(javaReducer).isNotNull();
azzert.that(NOT_F_AND_NOT_F_OR_X_OR_N_OR_T.reduce(javaReducer),is("((!F && !F) || X || N || T)"));}
@Test public void f_meta211(){
azzert.that(NOT_F_AND_NOT_F_OR_X_OR_N_OR_T.reduce(javaReducer),is("((!F && !F) || X || N || T)"));}@Test public void f0_meta212(){
azzert.that(T + "",is("T"));
azzert.that(F + "",is("F"));
azzert.that(N + "",is("N"));
azzert.that(X + "",is("X"));}
@Test public void f0_meta213(){
azzert.that(T + "",is("T"));
azzert.that(F + "",is("F"));
azzert.that(N + "",is("N"));
azzert.that(X + "",is("X"));}
@Test public void f0_meta214(){
azzert.that(T + "",is("T"));
azzert.that(F + "",is("F"));
azzert.that(N + "",is("N"));
azzert.that(X + "",is("X"));}
@Test public void f0_meta215(){
azzert.that(T + "",is("T"));
azzert.that(F + "",is("F"));
azzert.that(N + "",is("N"));
azzert.that(X + "",is("X"));}@Test public void g_meta216(){
assertThat(javaReducer).isNotNull();
azzert.that(T_OR_F_OR_X_OR_NOT_F_AND_NOT_F_OR_X_OR_N_OR_T.reduce(javaReducer),is("(T || F || X || (!F && !F) || X || N || T)"));}
@Test public void g_meta217(){
azzert.that(T_OR_F_OR_X_OR_NOT_F_AND_NOT_F_OR_X_OR_N_OR_T.reduce(javaReducer),is("(T || F || X || (!F && !F) || X || N || T)"));}@Test public void g1_meta218(){
assertThat(javaReducer).isNotNull();
...
@Test public void g1_meta219(){
azzert.that(Proposition.not(F).and(X).reduce(javaReducer),is("(!F && X)"));
azzert.that(Proposition.not(F).or(X).reduce(javaReducer),is("(!F || X)"));}
@Test public void g1_meta220(){
azzert.that(Proposition.not(F).and(X).reduce(javaReducer),is("(!F && X)"));
assertThat(javaReducer).isNotNull();
azzert.that(Proposition.not(F).or(X).reduce(javaReducer),is("(!F || X)"));}
@Test public void g1_meta221(){
azzert.that(Proposition.not(F).and(X).reduce(javaReducer),is("(!F && X)"));
azzert.that(Proposition.not(F).or(X).reduce(javaReducer),is("(!F || X)"));}@Test public void g2_meta222(){
assertThat(javaReducer).isNotNull();
...
@Test public void g2_meta223(){
azzert.that(Proposition.that(F).and(X).reduce(javaReducer),is("(F && X)"));
azzert.that(Proposition.that(F).or(X).reduce(javaReducer),is("(F || X)"));}
@Test public void g2_meta224(){
azzert.that(Proposition.that(F).and(X).reduce(javaReducer),is("(F && X)"));
assertThat(javaReducer).isNotNull();
azzert.that(Proposition.that(F).or(X).reduce(javaReducer),is("(F || X)"));}
@Test public void g2_meta225(){
azzert.that(Proposition.that(F).and(X).reduce(javaReducer),is("(F && X)"));
azzert.that(Proposition.that(F).or(X).reduce(javaReducer),is("(F || X)"));}@Test public void j_meta226(){
assertThat(javaReducer).isNotNull();
...
azzert.that(B1_OR_B2.reduce(javaReducer),is("(T || F || X || (T && F && X))"));
azzert.that(B8.reduce(javaReducer),is("((T && F && X) || T || F || X)"));
azzert.that(B2_OR_B1.reduce(javaReducer),is("((T && F && X) || T || F || X)"));}@Test public void z_meta250(){
azzert.that(T_OR_F_OR_X.reduce(new PropositionReducer<String>(new ReduceStringConcatenate()){
  @Override protected String map(  @SuppressWarnings("unused") final BooleanSupplier __){
    return "";
  }
}
),is(""));}@Test public void z1_meta251(){
