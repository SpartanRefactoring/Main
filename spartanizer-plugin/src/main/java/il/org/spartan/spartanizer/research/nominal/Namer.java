...
public class Namer {
  ...
  // * <li>If the argument is not {@code null} then the result is {@code null}
  // if
  ...
  // * @author Yossi Gil
  // * @since 2017-05-20 */
  // public interface Simplification extends UnaryOperator<String>,
  // Supplier<Type>{
  ...
  // }
  //
  // public interface AtomicSimplification extends Simplification,
  // Duplo.Atomic<Simplification>{
  // //Empty
  // }
  //
  // public interface CompundSimplification extends Simplification,
  // Duplo.Compound<Simplification>{
  // //Empty
  // }
  //
