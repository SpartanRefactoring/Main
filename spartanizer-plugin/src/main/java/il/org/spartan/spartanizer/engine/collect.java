...
import static il.org.spartan.Utils.removeDuplicates;
...
public enum collect {
   ...
   * declarations.
   * @param n JD
   * @return A {@link GUIApplicator}, with the uses of the provided identifier
   *         within declarations. */
   ...
   * @return {@link GUIApplicator} of all occurrences which are not
   *         definitions. */
