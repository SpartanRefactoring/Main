...
public final class typeTest {
  ...
  public static class Working {
    ...
    @Test public void assingment1() {
      azzert.that(of(parse.e("x = 2")), is(NUMERIC));
    }
    @Test public void assingment2() {
      azzert.that(of(parse.e("x = \"a string\"")), is(STRING));
    }
    @Test public void assingment3() {
      azzert.that(of(parse.e("x = true")), is(BOOLEAN));
    }
    @Test public void assingment4() {
      azzert.that(of(parse.e("x = new Float()")), is(NUMERIC));
    }
    @Test public void assingment5() {
      azzert.that(of(parse.e("x = new String()")), is(STRING));
    }
    @Test public void assingment6() {
      azzert.that(of(parse.e("x = new Object()")), is(baptize("Object")));
    }
    ...
    @Test public void basicExpression30() {
      azzert.that(of(parse.e("+x")), is(NUMERIC));
    }
    @Test public void basicExpression31() {
      azzert.that(of(parse.e("+x + +x")), is(NUMERIC));
    }
    @Test public void basicExpressions01() {
      azzert.that(of(parse.e("2 + (2.0)*1L")), is(DOUBLE));
    }
    @Test public void basicExpressions02() {
      azzert.that(of(parse.e("(int)(2 + (2.0)*1L)")), is(INT));
    }
    @Test public void basicExpressions03() {
      azzert.that(of(parse.e("(int)(2 + (2.0)*1L)==9.0")), is(BOOLEAN));
    }
    @Test public void basicExpressions04() {
      azzert.that(of(parse.e("9*3.0-f()")), is(DOUBLE));
    }
    @Test public void basicExpressions05() {
      azzert.that(of(parse.e("g()+f()")), is(ALPHANUMERIC));
    }
    @Test public void basicExpressions06() {
      azzert.that(of(parse.e("f(g()+h(),f(2))")), is(NOTHING));
    }
    @Test public void basicExpressions07() {
      azzert.that(of(parse.e("f()+null")), is(STRING));
    }
    @Test public void basicExpressions08() {
      azzert.that(of(parse.e("2+f()")), is(ALPHANUMERIC));
    }
    @Test public void basicExpressions09() {
      azzert.that(of(parse.e("2%f()")), is(INTEGRAL));
    }
    @Test public void basicExpressions10() {
      azzert.that(of(parse.e("2<<f()")), is(INT));
    }
    @Test public void basicExpressions11() {
      azzert.that(of(parse.e("f()<<2")), is(INTEGRAL));
    }
    @Test public void basicExpressions12() {
      azzert.that(of(parse.e("f()||g()")), is(BOOLEAN));
    }
    @Test public void basicExpressions13() {
      azzert.that(of(parse.e("x++")), is(NUMERIC));
    }
    @Test public void basicExpressions18() {
      azzert.that(of(parse.e("((short)1)+((short)2)")), is(INT));
    }
    @Test public void basicExpressions19() {
      azzert.that(of(parse.e("((byte)1)+((byte)2)")), is(INT));
    }
    @Test public void basicExpressions20() {
      azzert.that(of(parse.e("1f + 1")), is(FLOAT));
    }
    @Test public void basicExpressions21() {
      azzert.that(of(parse.e("1f + 1l")), is(FLOAT));
    }
    @Test public void basicExpressions22() {
      azzert.that(of(parse.e("1F + 'a'")), is(FLOAT));
    }
    @Test public void basicExpressions23() {
      azzert.that(of(parse.e("1f + 1.")), is(DOUBLE));
    }
    @Test public void basicExpressions24() {
      azzert.that(of(parse.e("1f / f()")), is(NUMERIC));
    }
    @Test public void basicExpressions25() {
      azzert.that(of(parse.e("1+2+3l")), is(LONG));
    }
    @Test public void basicExpressions26() {
      azzert.that(of(parse.e("1+2f+3l-5-4d")), is(DOUBLE));
    }
    @Test public void basicExpressions27() {
      azzert.that(of(parse.e("1+2f+3l+f()-5-4d")), is(DOUBLE));
    }
    @Test public void basicExpressions28() {
      azzert.that(of(parse.e("1+2f+3l+f()")), is(ALPHANUMERIC));
    }
    @Test public void basticExpression29() {
      final InfixExpression e = az.infixExpression(parse.e("null+3"));
    ...
    @Test public void cast01() {
      azzert.that(of(parse.e("(List)f()")), is(baptize("List")));
    }
    @Test public void cast02() {
      azzert.that(of(parse.e("(char)x")), is(CHAR));
    }
    @Test public void cast03() {
      azzert.that(of(parse.e("(Character)x")), is(CHAR));
    }
    @Test public void cast04() {
      azzert.that(of(parse.e("(int)x")), is(INT));
    }
    @Test public void cast05() {
      azzert.that(of(parse.e("(Integer)x")), is(INT));
    }
    @Test public void cast06() {
      azzert.that(of(parse.e("(long)x")), is(LONG));
    }
    @Test public void cast07() {
      azzert.that(of(parse.e("(Long)x")), is(LONG));
    }
    @Test public void cast08() {
      azzert.that(of(parse.e("(double)x")), is(DOUBLE));
    }
    @Test public void cast09() {
      azzert.that(of(parse.e("(Double)x")), is(DOUBLE));
    }
    @Test public void cast10() {
      azzert.that(of(parse.e("(boolean)x")), is(BOOLEAN));
    }
    @Test public void cast11() {
      azzert.that(of(parse.e("(Boolean)x")), is(BOOLEAN));
    }
    @Test public void cast12() {
      azzert.that(of(parse.e("(String)x")), is(STRING));
    }
    @Test public void cast13() {
      azzert.that(of(parse.e("(byte)1")), is(BYTE));
    }
    @Test public void cast14() {
      azzert.that(of(parse.e("(Byte)1")), is(BYTE));
    }
    @Test public void cast15() {
      azzert.that(of(parse.e("(short)1")), is(SHORT));
    }
    @Test public void cast16() {
      azzert.that(of(parse.e("(Short)1")), is(SHORT));
    }
    @Test public void cast17() {
      azzert.that(of(parse.e("(float)1")), is(FLOAT));
    }
    @Test public void cast18() {
      azzert.that(of(parse.e("(Float)1")), is(FLOAT));
    }
    @Test public void cast19() {
      azzert.that(of(parse.e("(float)1d")), is(FLOAT));
    }
    @Test public void cast20() {
      azzert.that(of(parse.e("(Integer)null")), is(NULL));
    }
    @Test public void cast21() {
      azzert.that(of(parse.e("(Integer)((null))")), is(NULL));
    }
    @Test public void conditional01() {
      azzert.that(of(parse.e("f() ? 3 : 7")), is(INT));
    }
    @Test public void conditional02() {
      azzert.that(of(parse.e("f() ? 3L : 7")), is(LONG));
    }
    @Test public void conditional03() {
      azzert.that(of(parse.e("f() ? 3L : 7.")), is(DOUBLE));
    }
    @Test public void conditional04() {
      azzert.that(of(parse.e("f() ? 3 : (short)7")), is(SHORT));
    }
    @Test public void conditional05() {
      azzert.that(of(parse.e("f() ? 'a' : 7.")), is(DOUBLE));
    }
    @Test public void conditional06() {
      azzert.that(of(parse.e("f() ? 'a' : 'b'")), is(CHAR));
    }
    @Test public void conditional07() {
      azzert.that(of(parse.e("f() ? \"abc\" : \"def\"")), is(STRING));
    }
    @Test public void conditional08() {
      azzert.that(of(parse.e("f() ? true : false")), is(BOOLEAN));
    }
    @Test public void conditional09() {
      azzert.that(of(parse.e("f() ? f() : false")), is(NOTHING));
    }
    @Test public void conditional10() {
      azzert.that(of(parse.e("f() ? f() : 2")), is(NOTHING));
    }
    @Test public void conditional11() {
      azzert.that(of(parse.e("f() ? f() : 2l")), is(NOTHING));
    }
    @Test public void conditional12() {
      azzert.that(of(parse.e("f() ? 2. : g()")), is(NOTHING));
    }
    @Test public void conditional13() {
      azzert.that(of(parse.e("f() ? 2 : 2%f()")), is(INTEGRAL));
    }
    @Test public void conditional14() {
      azzert.that(of(parse.e("f() ? x : 'a'")), is(NOTHING));
    }
    @Test public void conditional15() {
      azzert.that(of(parse.e("f() ? x : g()")), is(NOTHING));
    }
    @Test public void conditional16() {
      azzert.that(of(parse.e("f() ? \"a\" : h()")), is(NOTHING));
    }
    @Test public void conditional17() {
      azzert.that(of(parse.e("s.equals(532)?y(2)+10:r(3)-6")), is(NOTHING));
    }
    @Test public void conditional18() {
      azzert.that(of(parse.e("b ? y(2)+10 : x-6")), is(NOTHING));
    }
    @Test public void conditional19() {
      azzert.that(of(parse.e("b ? \"\" : 7")), is(NOTHING));
    }
    @Test public void conditional20() {
      azzert.that(of(parse.e("b ? (byte)3 : 7")), is(INT));
    }
    @Test public void conditional21() {
      azzert.that(of(parse.e("b ? (short)3 : 7")), is(SHORT));
    }
    @Test public void conditional22() {
      azzert.that(of(parse.e("b ? (short)3 : 7l")), is(LONG));
    }
    @Test public void conditional23() {
      azzert.that(of(parse.e("b ? (short)3 : 2147483647")), is(INT));
    }
    @Test public void constructors01() {
      azzert.that(of(parse.e("new List<Integer>()")), is(baptize("List<Integer>")));
      azzert.assertNotEquals(of(parse.e("new List<Integer>()")), baptize("List"));
    }
    @Test public void constructors02() {
      azzert.that(of(parse.e("new Object()")), is(baptize("Object")));
    }
    @Test public void constructors03() {
      azzert.that(of(parse.e("new String(\"hello\")")), is(STRING));
    }
    @Test public void constructors04() {
      azzert.that(of(parse.e("new Byte()")), is(BYTE));
    }
    @Test public void constructors05() {
      azzert.that(of(parse.e("new Double()")), is(DOUBLE));
    }
    @Test public void context01() {
      azzert.that(of(findFirst.ifStatement(parse.s("{if(f()) return x; return y;}")).getExpression()), is(BOOLEAN));
    }
    @Test public void context02() {
      azzert.that(of(az.prefixExpression(parse.e("++x")).getOperand()), is(NUMERIC));
    }
    ...
    @Test public void context19() {
      final InfixExpression e = az.infixExpression(parse.e("x - 9f"));
      azzert.that(of(e.getLeftOperand()), is(NUMERIC));
      azzert.that(of(e.getRightOperand()), is(FLOAT));
    }
    @Test @SuppressWarnings("unchecked") public void context20() {
      final ForStatement fs = findFirst.forStatement(parse.s("for(int i = 0;x;++i) somthing();"));
    ...
    @Test public void literal01() {
      azzert.that(of(parse.e("3")), is(INT));
    }
    @Test public void literal02() {
      azzert.that(of(parse.e("3l")), is(LONG));
    }
    @Test public void literal03() {
      azzert.that(of(parse.e("3L")), is(LONG));
    }
    @Test public void literal04() {
      azzert.that(of(parse.e("3d")), is(DOUBLE));
    }
    @Test public void literal05() {
      azzert.that(of(parse.e("3D")), is(DOUBLE));
    }
    @Test public void literal06() {
      azzert.that(of(parse.e("3.0d")), is(DOUBLE));
    }
    @Test public void literal07() {
      azzert.that(of(parse.e("3.02D")), is(DOUBLE));
    }
    @Test public void Literal08() {
      azzert.that(of(parse.e("3.098")), is(DOUBLE));
    }
    @Test public void literal09() {
      azzert.that(of(parse.e("3f")), is(FLOAT));
    }
    @Test public void literal10() {
      azzert.that(of(parse.e("3.f")), is(FLOAT));
    }
    @Test public void literal11() {
      azzert.that(of(parse.e("3.0f")), is(FLOAT));
    }
    @Test public void literals12() {
      azzert.that(of(parse.e("null")), is(NULL));
    }
    @Test public void literals13() {
      azzert.that(of(parse.e("(((null)))")), is(NULL));
    }
    @Test public void literals14() {
      azzert.that(of(parse.e("\"a string\"")), is(STRING));
    }
    @Test public void literals15() {
      azzert.that(of(parse.e("'a'")), is(CHAR));
    }
    @Test public void literals16() {
      azzert.that(of(parse.e("true")), is(BOOLEAN));
    }
    @Test public void makeSureIUnderstandSemanticsOfShift() {
      azzert.that(Axiom.type((short) 1 << 1L), is(INT));
    }
    @Test public void methods1() {
      azzert.that(of(parse.e("a.toString()")), is(STRING));
    }
    @Test public void methods2() {
      azzert.that(of(parse.e("a.fo()")), is(NOTHING));
    }
    @Test public void methods3() {
      azzert.that(of(parse.e("toString()")), is(STRING));
    }
    @Test public void methods4() {
      azzert.that(of(parse.e("toString(x,y)")), is(NOTHING));
    }
    ...
    @Test public void variableDeclarationStatement01() {
      azzert.that(of(extract.fragments(parse.s("int x = f();")).get(0).getInitializer()), is(INT));
    }
    @Test public void variableDeclarationStatement02() {
      azzert.that(of(extract.fragments(parse.s("Long x = 3.0;")).get(0).getInitializer()), is(DOUBLE));
    }
    @Test public void variableDeclarationStatement03() {
      azzert.that(of(extract.fragments(parse.s("Long x = 3.0;")).get(0).getInitializer()), is(DOUBLE));
    }
    @Test public void namespace01() {
      azzert.that(of(az.returnStatement(extract.statements(parse.s("int x = 3; return x+7;")).get(1)).getExpression()), is(INT));
    }
  }
}
